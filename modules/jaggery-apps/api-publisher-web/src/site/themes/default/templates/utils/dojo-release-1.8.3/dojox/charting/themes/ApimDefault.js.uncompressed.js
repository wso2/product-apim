define("dojox/charting/themes/ApimDefault", ["../Theme", "dojox/gfx/gradutils", "./common"], function(Theme, gradutils, themes){

    var g = Theme.generateGradient,
        defaultFill = {type: "linear", space: "shape", x1: 0, y1: 0, x2: 0, y2: 100};
	themes.ApimDefault = new Theme({
        chart: {
            fill:	   {
                type: "linear",
