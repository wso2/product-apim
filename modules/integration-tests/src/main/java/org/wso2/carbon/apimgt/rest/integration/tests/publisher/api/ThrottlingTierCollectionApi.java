...
public interface ThrottlingTierCollectionApi extends ApiClient.Api {
  ...
  TierList policiesTierLevelGet(@Param("tierLevel") String tierLevel, @Param("limit") Integer limit, @Param("offset")
  ...
  TierList policiesTierLevelGet(@Param("tierLevel") String tierLevel, @Param("ifNoneMatch") String ifNoneMatch,
