...
public class WorkflowList {
  ...
  public WorkflowList count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  **/
  ...
  public WorkflowList list(List<Workflow> list) {
    this.list = list;
    return this;
  }

  public WorkflowList addListItem(Workflow listItem) {
    if (this.list == null) {
      this.list = new ArrayList<Workflow>();
    }
