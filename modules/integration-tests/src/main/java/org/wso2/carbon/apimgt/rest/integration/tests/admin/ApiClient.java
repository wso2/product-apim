  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("OAuth2Security".equals(authName)) {
        auth = new OAuth(OAuthFlow.password, "", "https://localhost:9443/token", "apim:tier_view, apim:tier_manage, apim:bl_view, apim:bl_manage, apim:label_view, apim:label_manage, apim:workflow_view, apim:workflow_approve");
      } else {
