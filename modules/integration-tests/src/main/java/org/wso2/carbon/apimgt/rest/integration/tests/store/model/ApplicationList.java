...
import org.wso2.carbon.apimgt.rest.integration.tests.store.model.ApplicationInfo;
...
public class ApplicationList {
  ...
  @JsonProperty("list")
  private List<ApplicationInfo> list = null;
  ...
  **/
  ...
  public ApplicationList addListItem(ApplicationInfo listItem) {
    if (this.list == null) {
      this.list = new ArrayList<ApplicationInfo>();
    }
