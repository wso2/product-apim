...
public class CommentList {
   ...
   * @return count
  **/
  @ApiModelProperty(example = "null", value = "Number of Comments returned. ")
  ...
  public CommentList next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public CommentList previous(String previous) {
  ...
  **/
  ...
  public CommentList list(List<Comment> list) {
    this.list = list;
    return this;
  }

  public CommentList addListItem(Comment listItem) {
