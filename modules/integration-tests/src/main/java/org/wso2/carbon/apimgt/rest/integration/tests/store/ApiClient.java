...
import org.wso2.carbon.apimgt.rest.integration.tests.store.auth.*;
import org.wso2.carbon.apimgt.rest.integration.tests.store.auth.OAuth.AccessTokenListener;
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("OAuth2Security".equals(authName)) {
        auth = new OAuth(OAuthFlow.password, "", "https://localhost:9443/token", "apim:subscribe, apim:self-signup, apim:dedicated_gateway");
      } else {
