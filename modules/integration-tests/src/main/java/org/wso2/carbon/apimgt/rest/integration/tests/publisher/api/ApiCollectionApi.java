...
public interface ApiCollectionApi extends ApiClient.Api {
  ...
  API apisImportDefinitionPost(@Param("type") String type, @Param("file") File file, @Param("url") String url, @Param
          ("additionalProperties") String additionalProperties, @Param("implementationType") String
          implementationType, @Param("ifMatch") String ifMatch, @Param("ifUnmodifiedSince") String ifUnmodifiedSince);
