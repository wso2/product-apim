...
import org.wso2.carbon.apimgt.rest.integration.tests.publisher.auth.*;
import org.wso2.carbon.apimgt.rest.integration.tests.publisher.auth.OAuth.AccessTokenListener;
...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date =
        "2018-03-27T17:28:03.315+05:30")
public class ApiClient {
    public interface Api {
    }

    protected ObjectMapper objectMapper;
    private String basePath = "https://apis.wso2.com/api/am/publisher/v1.0";
    ...
    public ApiClient(String[] authNames) throws AMIntegrationTestException {
        ...
        for (String authName : authNames) {
            ...
            if ("OAuth2Security".equals(authName)) {
                auth = new OAuth(OAuthFlow.password, "", "https://localhost:9443/token", "apim:api_view, " +
                        "apim:api_create, apim:api_update, apim:api_delete, apim:apidef_update, apim:api_publish, " +
                        "apim:subscription_view, apim:subscription_block, apim:dedicated_gateway, " +
