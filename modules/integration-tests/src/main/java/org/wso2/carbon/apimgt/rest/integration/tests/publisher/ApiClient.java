  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("OAuth2Security".equals(authName)) {
        auth = new OAuth(OAuthFlow.password, "", "https://localhost:9443/token", "apim:api_view, apim:api_create, apim:api_update, apim:api_delete, apim:apidef_update, apim:api_publish, apim:subscription_view, apim:subscription_block, apim:dedicated_gateway, apim:external_services_discover");
      } else {
