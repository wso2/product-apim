...
public interface SubscriptionCollectionApi extends ApiClient.Api {
  ...
  SubscriptionList subscriptionsGet(@Param("apiId") String apiId, @Param("limit") Integer limit, @Param("offset")
  ...
  SubscriptionList subscriptionsGet(@Param("ifNoneMatch") String ifNoneMatch, @QueryMap(encoded = true) Map<String,
          Object> queryParams);
