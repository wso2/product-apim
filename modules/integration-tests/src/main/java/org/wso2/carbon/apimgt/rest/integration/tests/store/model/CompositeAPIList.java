...
public class CompositeAPIList {
  ...
  @JsonProperty("list")
  private List<CompositeAPIInfo> list = new ArrayList<CompositeAPIInfo>();

  public CompositeAPIList count(Integer count) {
    this.count = count;
    return this;
  }
   ...
   * @return count
  **/
  @ApiModelProperty(example = "null", value = "Number of Composite APIs returned. ")
  ...
  public CompositeAPIList next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public CompositeAPIList previous(String previous) {
  ...
  **/
  ...
  public CompositeAPIList list(List<CompositeAPIInfo> list) {
    this.list = list;
    return this;
  }

  public CompositeAPIList addListItem(CompositeAPIInfo listItem) {
  ...
  **/
  ...
  public List<CompositeAPIInfo> getList() {
    return list;
  }

  public void setList(List<CompositeAPIInfo> list) {
    this.list = list;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CompositeAPIList compositeAPIList = (CompositeAPIList) o;
  ...
  public String toString() {
    ...
    sb.append("class CompositeAPIList {\n");
