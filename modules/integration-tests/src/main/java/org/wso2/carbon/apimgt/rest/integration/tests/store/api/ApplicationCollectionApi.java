...
public interface ApplicationCollectionApi extends ApiClient.Api {
  ...
  ApplicationList applicationsGet(@Param("query") String query, @Param("limit") Integer limit, @Param("offset")
  ...
  ApplicationList applicationsGet(@Param("ifNoneMatch") String ifNoneMatch, @QueryMap(encoded = true) Map<String,
          Object> queryParams);
