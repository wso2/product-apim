...
ALTER COLUMN RATING_ID TYPE VARCHAR(255),
...
UPDATE AM_API_RATINGS SET RATING_ID=(SELECT uuid_generate_v1());
UPDATE AM_API_COMMENTS SET COMMENT_ID=(SELECT uuid_generate_v1());
