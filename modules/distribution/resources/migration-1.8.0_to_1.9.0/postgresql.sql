...
ALTER TABLE AM_API ADD (CREATED_BY VARCHAR(100), CREATED_TIME DATE, UPDATED_BY VARCHAR(100), UPDATED_TIME DATE);
ALTER TABLE AM_SUBSCRIBER ADD (CREATED_BY VARCHAR(100), CREATED_TIME DATE, UPDATED_BY VARCHAR(100), UPDATED_TIME DATE);
ALTER TABLE AM_SUBSCRIPTION ADD (CREATED_BY VARCHAR(100), CREATED_TIME DATE, UPDATED_BY VARCHAR(100), UPDATED_TIME DATE);
ALTER TABLE AM_APPLICATION ADD (CREATED_BY VARCHAR(100), CREATED_TIME DATE, UPDATED_BY VARCHAR(100), UPDATED_TIME DATE);