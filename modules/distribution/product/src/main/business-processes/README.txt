...
03. User interaction to approve workflow. User can log in to "Admin-Dashboard" jaggery app which is default ship with API manager 1.6.0 and approve process.The url for "admin-dashboard" jaggery application is "http[s]://ip:port/admin"
