...
findstr /i /c:"%bcprov_text%" "%api_publisher_bundles_info%" > nul
if %errorlevel%==0 (
    set verify=false
    echo Found text "%bcprov_text%" in api-publisher bundles.info. This should be removed.
)

findstr /i /c:"%bcpkix_text%" "%api_publisher_bundles_info%" > nul
if %errorlevel%==0 (
    set verify=false
    echo Found text "%bcpkix_text%" in api-publisher bundles.info. This should be removed.
)

findstr /i /c:"%bcprov_text%" "%api_devportal_bundles_info%" > nul
if %errorlevel%==0 (
    set verify=false
    echo Found text "%bcprov_text%" in api-devportal bundles.info. This should be removed.
)

findstr /i /c:"%bcpkix_text%" "%api_devportal_bundles_info%" > nul
if %errorlevel%==0 (
    set verify=false
    echo Found text "%bcpkix_text%" in api-devportal bundles.info. This should be removed.
)

findstr /i /c:"%bcprov_text%" "%api_key_manager_bundles_info%" > nul
if %errorlevel%==0 (
    set verify=false
    echo Found text "%bcprov_text%" in api-key-manager bundles.info. This should be removed.
)

findstr /i /c:"%bcpkix_text%" "%api_key_manager_bundles_info%" > nul
if %errorlevel%==0 (
    set verify=false
    echo Found text "%bcpkix_text%" in api-key-manager bundles.info. This should be removed.
)

findstr /i /c:"%bcprov_text%" "%default_bundles_info%" > nul
if %errorlevel%==0 (
    set verify=false
    echo Found text "%bcprov_text%" in default bundles.info. This should be removed.
)

findstr /i /c:"%bcpkix_text%" "%default_bundles_info%" > nul
if %errorlevel%==0 (
    set verify=false
    echo Found text "%bcpkix_text%" in default bundles.info. This should be removed.
)

findstr /i /c:"%bcprov_text%" "%traffic_manager_bundles_info%" > nul
if %errorlevel%==0 (
    set verify=false
    echo Found text "%bcprov_text%" in traffic-manager bundles.info. This should be removed.
)

findstr /i /c:"%bcpkix_text%" "%traffic_manager_bundles_info%" > nul
if %errorlevel%==0 (
    set verify=false
    echo Found text "%bcpkix_text%" in traffic-manager bundles.info. This should be removed.
)

findstr /i /c:"%bcprov_text%" "%gateway_worker_bundles_info%" > nul
if %errorlevel%==0 (
    set verify=false
    echo Found text "%bcprov_text%" in gateway-worker bundles.info. This should be removed.
)

findstr /i /c:"%bcpkix_text%" "%gateway_worker_bundles_info%" > nul
if %errorlevel%==0 (
    set verify=false
    echo Found text "%bcpkix_text%" in gateway-worker bundles.info. This should be removed.
)
