...
5. Run 'ant' inside wso2am-2.5.0/samples/Data
...
populate-user-database:
      [sql] Executing resource: .....  /wso2am-2.5.0/samples/Data/UserPopulator.sql
...
7. Run wso2am-2.5.0/samples/YahooPlaceFinder/APIPopulator.sh (or APIPopulator.bat if you are on Windows)
