...
1) Log in to the API Publisher (https://localhost:9443/publisher) and create the following API using the steps below.
   ...
   a) Designing the API
        ...
        Define 4 resources as per the information given in the table below
   ...
   b) Implementing the API
        ...
        Endpoint URL  : http://localhost:9765/pizzashack-api-1.0.0/api/
...
2) Login to the Management Console of the API Manager (https://localhost:9443/carbon) as the admin user (admin/admin) and perform the steps below.
