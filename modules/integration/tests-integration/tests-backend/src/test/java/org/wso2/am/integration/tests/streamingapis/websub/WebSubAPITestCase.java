...
public class WebSubAPITestCase extends APIMIntegrationBaseTest {
    ...
    public void testInvokeWebSubApiWithInvalidToken() throws Exception {
        ...
        assertEquals(response.getStatusLine().getStatusCode(), Response.Status.UNAUTHORIZED.getStatusCode(),
    ...
    public void testInvokeWebSubApiWithoutCallbackURL() throws Exception {
        ...
        assertEquals(response.getStatusLine().getStatusCode(), Response.Status.INTERNAL_SERVER_ERROR.getStatusCode(),
                "Response Code Mismatched");
        String responseBody = EntityUtils.toString(response.getEntity(), "UTF-8");
