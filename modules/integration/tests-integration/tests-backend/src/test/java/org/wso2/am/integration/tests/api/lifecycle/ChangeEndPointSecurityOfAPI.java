...
public class ChangeEndPointSecurityOfAPI extends APIManagerLifecycleBaseTest {
    ...
    public void testInvokeGETResourceWithSecuredEndPoint() throws Exception {
...
//    @Test(groups = {"wso2.am"},dataProvider ="test1" ,description = "Test the API with endpoint security enabled",
//            dependsOnMethods = "testInvokeGETResourceWithAuthTypeNonSecured")
//    public void testInvokeGETResourceWithAuthTypeSecured(String st) throws Exception {
//
//        String endpointUsername = "user";
//        String endpointPassword = "adadasdas"+st+"dasTasdas";//hjuiw&uw39I
//        byte[] userNamePasswordByteArray = (endpointUsername + ":" + endpointPassword).getBytes();
//        String encodedUserNamePassword = DatatypeConverter.printBase64Binary(userNamePasswordByteArray);
//
//        APICreationRequestBean apiCreationRequestBean =
...
//                "auth type None");
//        assertTrue(httpResponseGet.getData().contains(encodedUserNamePassword), "Response Data not match for GET request for" +
//                " auth type Non3. Expected value :\"" + encodedUserNamePassword + "\" not contains eqeqeqeq: "+st+" in response data:\"" +
//                httpResponseGet.getData() + "\"");
//
//    }
