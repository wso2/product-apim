...
public class ConfigurableDefaultPolicyTestCase extends APIMIntegrationBaseTest {
    ...
    public void setEnvironment() throws Exception {
        ...
        ApiResponse<SubscriptionThrottlePolicyDTO> subscriptionThrottlePolicyDTOApiResponse =
                restAPIAdmin.addSubscriptionThrottlingPolicy(new SubscriptionThrottlePolicyDTO().policyName(
                        "DefaultSubscriptionLevelTier").defaultLimit(defaultLimit).rateLimitCount(0)
                        .rateLimitTimeUnit("sec").billingPlan("FREE"));
        ...
        ApiResponse<ApplicationThrottlePolicyDTO> applicationThrottlePolicyDTOApiResponse =
                restAPIAdmin.addApplicationThrottlingPolicy(new ApplicationThrottlePolicyDTO().policyName(
                        "DefaultApplicationLevelTier")
