...
public class ApplicationThrottlingPolicyTestCase extends APIMIntegrationBaseTest {
    ...
    ApplicationThrottlePolicyDTO requestCountPolicyDTO;
    ApplicationThrottlePolicyDTO bandwidthPolicyDTO;
    ...
    public void testAddPolicyWithRequestCountLimit() throws Exception {
        ...
        //Verify created application throttling policy DTO
    ...
    public void testDeletePolicyWithNonExistentPolicyId() {
        ...
        try {
            restAPIAdmin
                    .deleteApplicationThrottlingPolicy(bandwidthPolicyDTO.getPolicyId() + UUID.randomUUID().toString());
        } catch (ApiException e) {
