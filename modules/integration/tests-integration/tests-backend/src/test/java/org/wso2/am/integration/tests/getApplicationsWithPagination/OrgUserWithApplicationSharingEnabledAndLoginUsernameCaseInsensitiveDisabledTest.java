...
/**
 * This will test fetching applications in the developer portal for a user who has an organization with
 * ApplicationSharing enabled and LoginUsernameCaseInsensitive disabled
 */
public class OrgUserWithApplicationSharingEnabledAndLoginUsernameCaseInsensitiveDisabledTest
    ...
    public OrgUserWithApplicationSharingEnabledAndLoginUsernameCaseInsensitiveDisabledTest(TestUserMode userMode) {
        ...
        if (userMode == TestUserMode.SUPER_TENANT_ADMIN) {
            ...
            serverConfigurationManager.applyConfiguration(new File(
                            getAMResourceLocation() + File.separator + "configFiles" + File.separator
                                    ...
                                    + "enable_application_sharing_disable_login_username_case_insensitive_deployment.toml"),
    ...
    @Test(groups = { "wso2.am" }, description = "Check getting applications with pagination for user having organization"
            + " with ApplicationSharing enabled and LoginUsernameCaseInsensitive disabled")
