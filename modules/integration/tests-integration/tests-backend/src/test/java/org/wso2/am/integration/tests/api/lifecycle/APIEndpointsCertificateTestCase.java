...
public class APIEndpointsCertificateTestCase extends APIManagerLifecycleBaseTest {
    private static final Log log = LogFactory.getLog(APIEndpointsCertificateTestCase.class);
    ...
    public APIEndpointsCertificateTestCase(TestUserMode userMode) {
    ...
    private boolean isPortFree(int port) {
        ...
        Socket s = null;
        try {
            s = new Socket(securedEndpointHost, port);
