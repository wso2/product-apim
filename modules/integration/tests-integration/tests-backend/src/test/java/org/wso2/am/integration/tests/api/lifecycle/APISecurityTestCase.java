...
public class APISecurityTestCase extends APIManagerLifecycleBaseTest {
    ...
    public void testCreateAndPublishAPIWithOAuth2()
        ...
        assertEquals(apiResponse.getResponseCode(), HTTP_RESPONSE_CODE_OK,
                "API invocation failed for a test case with valid access token when the API is protected with both mutual sso and oauth2");
    }
