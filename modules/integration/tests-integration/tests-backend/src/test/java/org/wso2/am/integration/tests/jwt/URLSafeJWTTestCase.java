...
public class URLSafeJWTTestCase extends APIManagerLifecycleBaseTest {
    ...
    String subscriberUsername = "subscriberUser";
    ...
    public void testEnableJWTAndClaims() throws Exception {
        apiName = "UrlSafeJWTTokenClaimTestAPI";
        apiContext = "UrlSafeJWTTokenClaimTestAPIContext";
        applicationName = "UrlSafeJWTClaimsTestApp";
    ...
    public void testAPIAccessWhenJWTCachingEnabledTestCase()
            throws Exception {
        apiName = "UrlSafeJWTTokenCacheTestAPI";
        apiContext = "UrlSafeJWTTokenCacheTestAPI";
        description = "UrlSafeJWTTokenCacheTestAPI description";
        applicationName = "UrlSafeJWTTokenCacheTestApp";
        int waitingSecs = 20;
