...
public class APIVisibilityByPublicTestCase extends APIManagerLifecycleBaseTest {
    ...
    public void tesVisibilityForCreatorInPublisher() throws APIManagerIntegrationTestException, JSONException {
        ...
        createAPI(API1_NAME, API1_CONTEXT, API_VERSION_1_0_0, API1_TAGS, "public", "", apiPublisherClientUser2);
    ...
    public void tesVisibilityForAnonymousUserInSameDomainInStore() throws XPathExpressionException,
        ...
        assertEquals(httpResponse.getData().contains(API1_NAME), true, "API is not visible to anonymous user in same " +
                "domain API Store. When Visibility is public.  " + getAPIIdentifierString(apiIdentifier));
