...
public class SoapToRestTestCase extends APIManagerLifecycleBaseTest {
    ...
    public void testInvokeSoapToRestAPIUsingJWTApplication() throws Exception {
        ...
        testAppId2 = createSoapToRestAppAndSubscribeToAPI(graphqlJwtAppName, "JWT", soapToRestAPIId);
    ...
    public void testInvokeSoapToRestAPIUsingOAuthApplication() throws Exception {
        ...
        testAppId3 = createSoapToRestAppAndSubscribeToAPI(soapToRestOAUTHAppName, "OAUTH", soapToRestAPIId);
    ...
    public void testOperationalLevelOAuthScopesForSoapToRest()
        ...
        testAppId4 = createSoapToRestAppAndSubscribeToAPI("testOperationalLevelOAuthScopesForSoapToRest", "OAUTH",
                soapToRestAPIId);
        waitForAPIDeployment();
