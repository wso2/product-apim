...
public class HostObjectTestCase extends APIManagerIntegrationTest {
	...
	public static boolean validatePublisherResponseArray(String[] array) {
		...
		Assert.assertTrue(array[32].contains("false"),
