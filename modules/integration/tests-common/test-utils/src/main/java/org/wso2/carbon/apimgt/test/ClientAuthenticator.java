...
public class ClientAuthenticator {
    ...
    public static String getAccessToken(String scopeList) {
        if (consumerKey == null) {
            makeDCRRequest();
        }
        URL url;
    ...
    public static String getAccessTokenForTenant(String scopeList, String tenantDomain, String adminUsername,
