...
public class GlobalMediationPoliciesApi {
     ...
     */
    public okhttp3.Call getAllGlobalMediationPoliciesCall(Integer limit, Integer offset, String query, String ifNoneMatch, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllGlobalMediationPoliciesValidateBeforeCall(Integer limit, Integer offset, String query, String ifNoneMatch, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAllGlobalMediationPoliciesCall(limit, offset, query, ifNoneMatch, _callback);
        return localVarCall;
    ...
    public MediationListDTO getAllGlobalMediationPolicies(Integer limit, Integer offset, String query, String ifNoneMatch) throws ApiException {
        ApiResponse<MediationListDTO> localVarResp = getAllGlobalMediationPoliciesWithHttpInfo(limit, offset, query, ifNoneMatch);
    ...
    public ApiResponse<MediationListDTO> getAllGlobalMediationPoliciesWithHttpInfo(Integer limit, Integer offset, String query, String ifNoneMatch) throws ApiException {
        okhttp3.Call localVarCall = getAllGlobalMediationPoliciesValidateBeforeCall(limit, offset, query, ifNoneMatch, null);
     ...
     */
    public okhttp3.Call getAllGlobalMediationPoliciesAsync(Integer limit, Integer offset, String query, String ifNoneMatch, final ApiCallback<MediationListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllGlobalMediationPoliciesValidateBeforeCall(limit, offset, query, ifNoneMatch, _callback);
        Type localVarReturnType = new TypeToken<MediationListDTO>(){}.getType();
