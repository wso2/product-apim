...
public class EnvironmentCollectionApi {
     ...
     */
    public EnvironmentListDTO environmentsGet(String apiId) throws ApiException {
        ApiResponse<EnvironmentListDTO> resp = environmentsGetWithHttpInfo(apiId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<EnvironmentListDTO> environmentsGetWithHttpInfo(String apiId) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call environmentsGetAsync(String apiId, final ApiCallback<EnvironmentListDTO> callback) throws ApiException {
