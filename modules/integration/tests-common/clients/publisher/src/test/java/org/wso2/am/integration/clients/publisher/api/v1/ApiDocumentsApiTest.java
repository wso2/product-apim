...
/**
 * API tests for ApiDocumentsApi
 */
@Ignore
public class ApiDocumentsApiTest {

    private final ApiDocumentsApi api = new ApiDocumentsApi();
    ...
    public void validateDocumentTest() throws ApiException {
        ...
        String name = null;
        String ifMatch = null;
        DocumentDTO response = api.validateDocument(apiId, name, ifMatch);
