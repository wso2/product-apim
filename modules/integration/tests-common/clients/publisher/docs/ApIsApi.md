...
# **apisApiIdPut**
> APIDTO apisApiIdPut(apiId, APIDTO, ifMatch)
...
public class Example {
  public static void main(String[] args) {
    ...
    String ifMatch = "ifMatch_example"; // String | Validator for conditional requests; based on ETag. 
    try {
      APIDTO result = apiInstance.apisApiIdPut(apiId, APIDTO, ifMatch);
      System.out.println(result);
    } catch (ApiException e) {
...
# **apisApiIdSwaggerPut**
> String apisApiIdSwaggerPut(apiId, ifMatch, apiDefinition, url, file)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      String result = apiInstance.apisApiIdSwaggerPut(apiId, ifMatch, apiDefinition, url, file);
      System.out.println(result);
    } catch (ApiException e) {
...
> APIDTO apisImportGraphqlSchemaPost(ifMatch, type, file, additionalProperties)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      APIDTO result = apiInstance.apisImportGraphqlSchemaPost(ifMatch, type, file, additionalProperties);
      System.out.println(result);
    } catch (ApiException e) {
...
<a name="apisPost"></a>
# **apisPost**
> APIDTO apisPost(APIDTO, openAPIVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      APIDTO result = apiInstance.apisPost(APIDTO, openAPIVersion);
      System.out.println(result);
    } catch (ApiException e) {
