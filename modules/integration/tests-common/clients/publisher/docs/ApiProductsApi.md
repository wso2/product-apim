...
[**apiProductsApiProductIdIsOutdatedGet**](ApiProductsApi.md#apiProductsApiProductIdIsOutdatedGet) | **GET** /api-products/{apiProductId}/is-outdated | Check Whether API Product is Outdated
...
> APIProductDTO apiProductsApiProductIdPut(apiProductId, apIProductDTO, ifMatch)
...
public class Example {
  public static void main(String[] args) {
    ...
    String ifMatch = "ifMatch_example"; // String | Validator for conditional requests; based on ETag. 
    try {
      APIProductDTO result = apiInstance.apiProductsApiProductIdPut(apiProductId, apIProductDTO, ifMatch);
      System.out.println(result);
    } catch (ApiException e) {
...
# **apiProductsPost**
> APIProductDTO apiProductsPost(apIProductDTO)
...
public class Example {
  public static void main(String[] args) {
    ...
    APIProductDTO apIProductDTO = new APIProductDTO(); // APIProductDTO | API object that needs to be added
    try {
      APIProductDTO result = apiInstance.apiProductsPost(apIProductDTO);
      System.out.println(result);
    } catch (ApiException e) {
