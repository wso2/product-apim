...
> apisApiIdGraphqlPoliciesComplexityPut(apiId, graphQLQueryComplexityInfoDTO)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.apisApiIdGraphqlPoliciesComplexityPut(apiId, graphQLQueryComplexityInfoDTO);
    } catch (ApiException e) {
