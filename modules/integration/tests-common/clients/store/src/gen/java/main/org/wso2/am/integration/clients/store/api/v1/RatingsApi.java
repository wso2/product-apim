...
public class RatingsApi {
    ...
    /**
     * Build call for apiProductsApiProductIdRatingsGet
     ...
     */
    public com.squareup.okhttp.Call apiProductsApiProductIdRatingsGetCall(String apiProductId, Integer limit, Integer offset, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api-products/{apiProductId}/ratings"
    ...
    private com.squareup.okhttp.Call apiProductsApiProductIdRatingsGetValidateBeforeCall(String apiProductId, Integer limit, Integer offset, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'apiProductId' is set
        if (apiProductId == null) {
            throw new ApiException("Missing the required parameter 'apiProductId' when calling apiProductsApiProductIdRatingsGet(Async)");
        }
        

        com.squareup.okhttp.Call call = apiProductsApiProductIdRatingsGetCall(apiProductId, limit, offset, progressListener, progressRequestListener);
        return call;
     ...
     */
    public RatingListDTO apiProductsApiProductIdRatingsGet(String apiProductId, Integer limit, Integer offset) throws ApiException {
        ApiResponse<RatingListDTO> resp = apiProductsApiProductIdRatingsGetWithHttpInfo(apiProductId, limit, offset);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RatingListDTO> apiProductsApiProductIdRatingsGetWithHttpInfo(String apiProductId, Integer limit, Integer offset) throws ApiException {
        com.squareup.okhttp.Call call = apiProductsApiProductIdRatingsGetValidateBeforeCall(apiProductId, limit, offset, null, null);
        Type localVarReturnType = new TypeToken<RatingListDTO>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get API Product ratings (asynchronously)
     * Get the rating of an API Product. 
     * @param apiProductId **API Product ID** consisting of the **UUID** of the API Product.  (required)
     * @param limit Maximum size of resource array to return.  (optional, default to 25)
     * @param offset Starting point within the complete list of items qualified.  (optional, default to 0)
     ...
     */
    public com.squareup.okhttp.Call apiProductsApiProductIdRatingsGetAsync(String apiProductId, Integer limit, Integer offset, final ApiCallback<RatingListDTO> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = apiProductsApiProductIdRatingsGetValidateBeforeCall(apiProductId, limit, offset, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RatingListDTO>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for apiProductsApiProductIdRatingsRatingIdGet
     * @param apiProductId **API Product ID** consisting of the **UUID** of the API Product.  (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call apiProductsApiProductIdRatingsRatingIdGetCall(String apiProductId, String ratingId, String ifNoneMatch, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api-products/{apiProductId}/ratings/{ratingId}"
            .replaceAll("\\{" + "apiProductId" + "\\}", apiClient.escapeString(apiProductId.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call apiProductsApiProductIdRatingsRatingIdGetValidateBeforeCall(String apiProductId, String ratingId, String ifNoneMatch, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'apiProductId' is set
        if (apiProductId == null) {
            throw new ApiException("Missing the required parameter 'apiProductId' when calling apiProductsApiProductIdRatingsRatingIdGet(Async)");
        }
        
        // verify the required parameter 'ratingId' is set
        if (ratingId == null) {
            throw new ApiException("Missing the required parameter 'ratingId' when calling apiProductsApiProductIdRatingsRatingIdGet(Async)");
        }
        

        com.squareup.okhttp.Call call = apiProductsApiProductIdRatingsRatingIdGetCall(apiProductId, ratingId, ifNoneMatch, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RatingDTO apiProductsApiProductIdRatingsRatingIdGet(String apiProductId, String ratingId, String ifNoneMatch) throws ApiException {
        ApiResponse<RatingDTO> resp = apiProductsApiProductIdRatingsRatingIdGetWithHttpInfo(apiProductId, ratingId, ifNoneMatch);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RatingDTO> apiProductsApiProductIdRatingsRatingIdGetWithHttpInfo(String apiProductId, String ratingId, String ifNoneMatch) throws ApiException {
        com.squareup.okhttp.Call call = apiProductsApiProductIdRatingsRatingIdGetValidateBeforeCall(apiProductId, ratingId, ifNoneMatch, null, null);
        Type localVarReturnType = new TypeToken<RatingDTO>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get a single API Product rating (asynchronously)
     * Get a specific rating of an API Product. 
     * @param apiProductId **API Product ID** consisting of the **UUID** of the API Product.  (required)
     * @param ratingId Rating Id  (required)
     * @param ifNoneMatch Validator for conditional requests; based on the ETag of the formerly retrieved variant of the resourec.  (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call apiProductsApiProductIdRatingsRatingIdGetAsync(String apiProductId, String ratingId, String ifNoneMatch, final ApiCallback<RatingDTO> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = apiProductsApiProductIdRatingsRatingIdGetValidateBeforeCall(apiProductId, ratingId, ifNoneMatch, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RatingDTO>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for apiProductsApiProductIdUserRatingPut
     * @param apiProductId **API Product ID** consisting of the **UUID** of the API Product.  (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call apiProductsApiProductIdUserRatingPutCall(String apiProductId, RatingDTO body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;

        // create path and map variables
        String localVarPath = "/api-products/{apiProductId}/user-rating"
            .replaceAll("\\{" + "apiProductId" + "\\}", apiClient.escapeString(apiProductId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call apiProductsApiProductIdUserRatingPutValidateBeforeCall(String apiProductId, RatingDTO body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'apiProductId' is set
        if (apiProductId == null) {
            throw new ApiException("Missing the required parameter 'apiProductId' when calling apiProductsApiProductIdUserRatingPut(Async)");
        }
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling apiProductsApiProductIdUserRatingPut(Async)");
        }
        

        com.squareup.okhttp.Call call = apiProductsApiProductIdUserRatingPutCall(apiProductId, body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RatingDTO apiProductsApiProductIdUserRatingPut(String apiProductId, RatingDTO body) throws ApiException {
        ApiResponse<RatingDTO> resp = apiProductsApiProductIdUserRatingPutWithHttpInfo(apiProductId, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RatingDTO> apiProductsApiProductIdUserRatingPutWithHttpInfo(String apiProductId, RatingDTO body) throws ApiException {
        com.squareup.okhttp.Call call = apiProductsApiProductIdUserRatingPutValidateBeforeCall(apiProductId, body, null, null);
        Type localVarReturnType = new TypeToken<RatingDTO>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Add or update logged in user&#39;s rating for an API Product (asynchronously)
     * Adds or updates a rating 
     * @param apiProductId **API Product ID** consisting of the **UUID** of the API Product.  (required)
     * @param body Rating object that should to be added  (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call apiProductsApiProductIdUserRatingPutAsync(String apiProductId, RatingDTO body, final ApiCallback<RatingDTO> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = apiProductsApiProductIdUserRatingPutValidateBeforeCall(apiProductId, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RatingDTO>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
