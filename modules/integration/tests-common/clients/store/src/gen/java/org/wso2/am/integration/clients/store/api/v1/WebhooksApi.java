...
public class WebhooksApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> OK. Topic list returned.  </td><td>  * ETag - Entity Tag of the response resource. Used by caches, or in conditional requests.  <br>  </td></tr>
        <tr><td> 404 </td><td> Not Found. The specified resource does not exist. </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Internal Server Error. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getAllWebhooksOfAPICall(String applicationId, String apiId, String xWSO2Tenant, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllWebhooksOfAPIValidateBeforeCall(String applicationId, String apiId, String xWSO2Tenant, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAllWebhooksOfAPICall(applicationId, apiId, xWSO2Tenant, _callback);
        return localVarCall;
     ...
     */
    public WebhookSubscriptionListDTO getAllWebhooksOfAPI(String applicationId, String apiId, String xWSO2Tenant) throws ApiException {
        ApiResponse<WebhookSubscriptionListDTO> localVarResp = getAllWebhooksOfAPIWithHttpInfo(applicationId, apiId, xWSO2Tenant);
     ...
     * @param apiId **API ID** consisting of the **UUID** of the API.  (optional)
     * @param xWSO2Tenant For cross-tenant invocations, this is used to specify the tenant domain, where the resource need to be   retrieved from.  (optional)
     * @return ApiResponse&lt;WebhookSubscriptionListDTO&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<WebhookSubscriptionListDTO> getAllWebhooksOfAPIWithHttpInfo(String applicationId, String apiId, String xWSO2Tenant) throws ApiException {
        okhttp3.Call localVarCall = getAllWebhooksOfAPIValidateBeforeCall(applicationId, apiId, xWSO2Tenant, null);
        Type localVarReturnType = new TypeToken<WebhookSubscriptionListDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get available web hook subscriptions for a given application.  (asynchronously)
     * This operation will provide a list of web hook topic subscriptions for a given application. If the api id is provided results will be filtered by the api Id. 
     * @param applicationId **Application Identifier** consisting of the UUID of the Application.  (optional)
     * @param apiId **API ID** consisting of the **UUID** of the API.  (optional)
     * @param xWSO2Tenant For cross-tenant invocations, this is used to specify the tenant domain, where the resource need to be   retrieved from.  (optional)
     ...
     */
    public okhttp3.Call getAllWebhooksOfAPIAsync(String applicationId, String apiId, String xWSO2Tenant, final ApiCallback<WebhookSubscriptionListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllWebhooksOfAPIValidateBeforeCall(applicationId, apiId, xWSO2Tenant, _callback);
        Type localVarReturnType = new TypeToken<WebhookSubscriptionListDTO>(){}.getType();
