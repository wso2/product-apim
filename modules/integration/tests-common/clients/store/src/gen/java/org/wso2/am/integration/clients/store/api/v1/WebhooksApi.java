...
public class WebhooksApi {
     ...
     */
    public okhttp3.Call webhooksSubscriptionsGetCall(String applicationId, String apiId, String xWSO2Tenant, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call webhooksSubscriptionsGetValidateBeforeCall(String applicationId, String apiId, String xWSO2Tenant, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = webhooksSubscriptionsGetCall(applicationId, apiId, xWSO2Tenant, _callback);
        return localVarCall;
    ...
    public WebhookSubscriptionListDTO webhooksSubscriptionsGet(String applicationId, String apiId, String xWSO2Tenant) throws ApiException {
        ApiResponse<WebhookSubscriptionListDTO> localVarResp = webhooksSubscriptionsGetWithHttpInfo(applicationId, apiId, xWSO2Tenant);
    ...
    public ApiResponse<WebhookSubscriptionListDTO> webhooksSubscriptionsGetWithHttpInfo(String applicationId, String apiId, String xWSO2Tenant) throws ApiException {
        okhttp3.Call localVarCall = webhooksSubscriptionsGetValidateBeforeCall(applicationId, apiId, xWSO2Tenant, null);
     ...
     */
    public okhttp3.Call webhooksSubscriptionsGetAsync(String applicationId, String apiId, String xWSO2Tenant, final ApiCallback<WebhookSubscriptionListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = webhooksSubscriptionsGetValidateBeforeCall(applicationId, apiId, xWSO2Tenant, _callback);
        Type localVarReturnType = new TypeToken<WebhookSubscriptionListDTO>(){}.getType();
