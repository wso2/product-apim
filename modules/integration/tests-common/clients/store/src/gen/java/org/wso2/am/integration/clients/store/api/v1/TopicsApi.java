...
public class TopicsApi {
     ...
     */
    public okhttp3.Call getAllTopicsOfAPICall(String apiId, String xWSO2Tenant, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllTopicsOfAPIValidateBeforeCall(String apiId, String xWSO2Tenant, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'apiId' is set
        if (apiId == null) {
            throw new ApiException("Missing the required parameter 'apiId' when calling getAllTopicsOfAPI(Async)");
        }
        

        okhttp3.Call localVarCall = getAllTopicsOfAPICall(apiId, xWSO2Tenant, _callback);
        return localVarCall;
     ...
     */
    public TopicListDTO getAllTopicsOfAPI(String apiId, String xWSO2Tenant) throws ApiException {
        ApiResponse<TopicListDTO> localVarResp = getAllTopicsOfAPIWithHttpInfo(apiId, xWSO2Tenant);
     ...
     * @param apiId **API ID** consisting of the **UUID** of the API.  (required)
     * @param xWSO2Tenant For cross-tenant invocations, this is used to specify the tenant domain, where the resource need to be   retrieved from.  (optional)
     * @return ApiResponse&lt;TopicListDTO&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<TopicListDTO> getAllTopicsOfAPIWithHttpInfo(String apiId, String xWSO2Tenant) throws ApiException {
        okhttp3.Call localVarCall = getAllTopicsOfAPIValidateBeforeCall(apiId, xWSO2Tenant, null);
        Type localVarReturnType = new TypeToken<TopicListDTO>(){}.getType();
     ...
     */
    public okhttp3.Call getAllTopicsOfAPIAsync(String apiId, String xWSO2Tenant, final ApiCallback<TopicListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllTopicsOfAPIValidateBeforeCall(apiId, xWSO2Tenant, _callback);
        Type localVarReturnType = new TypeToken<TopicListDTO>(){}.getType();
