...
public class ApiProductDocumentsApiTest {
    ...
    public void apiProductsApiProductIdDocumentsDocumentIdContentGetTest() throws ApiException {
        ...
        api.apiProductsApiProductIdDocumentsDocumentIdContentGet(apiProductId, documentId, ifNoneMatch);
    ...
    public void apiProductsApiProductIdDocumentsDocumentIdGetTest() throws ApiException {
        ...
        String ifNoneMatch = null;
        DocumentDTO response = api.apiProductsApiProductIdDocumentsDocumentIdGet(apiProductId, documentId, xWSO2Tenant, ifNoneMatch);
    ...
    public void apiProductsApiProductIdDocumentsGetTest() throws ApiException {
        ...
        String xWSO2Tenant = null;
        String ifNoneMatch = null;
        DocumentListDTO response = api.apiProductsApiProductIdDocumentsGet(apiProductId, limit, offset, xWSO2Tenant, ifNoneMatch);
