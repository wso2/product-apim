...
> SubscriptionThrottlePolicyListDTO throttlingPoliciesSubscriptionGet(accept, ifNoneMatch, ifModifiedSince)
...
//import org.wso2.am.integration.clients.admin.api.v1.SubscriptionPolicyCollectionApi;
...
try {
    SubscriptionThrottlePolicyListDTO result = apiInstance.throttlingPoliciesSubscriptionGet(accept, ifNoneMatch, ifModifiedSince);
...
[**SubscriptionThrottlePolicyListDTO**](SubscriptionThrottlePolicyListDTO.md)
...
> SubscriptionThrottlePolicyDTO throttlingPoliciesSubscriptionPost(body, contentType)
...
SubscriptionPolicyCollectionApi apiInstance = new SubscriptionPolicyCollectionApi();
SubscriptionThrottlePolicyDTO body = new SubscriptionThrottlePolicyDTO(); // SubscriptionThrottlePolicyDTO | Subscripion level policy object that should to be added 
String contentType = "application/json"; // String | Media type of the entity in the body. Default is application/json. 
try {
    SubscriptionThrottlePolicyDTO result = apiInstance.throttlingPoliciesSubscriptionPost(body, contentType);
    System.out.println(result);
} catch (ApiException e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**SubscriptionThrottlePolicyDTO**](SubscriptionThrottlePolicyDTO.md)| Subscripion level policy object that should to be added  |
