...
//import org.wso2.am.integration.clients.admin.api.v1.BlacklistIndividualApi;
...
> BlockingConditionDTO throttlingBlacklistConditionIdGet(conditionId, ifNoneMatch, ifModifiedSince)
...
try {
    BlockingConditionDTO result = apiInstance.throttlingBlacklistConditionIdGet(conditionId, ifNoneMatch, ifModifiedSince);
