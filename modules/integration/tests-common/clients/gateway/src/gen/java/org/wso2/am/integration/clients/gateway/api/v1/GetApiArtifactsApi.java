...
public class GetApiArtifactsApi {
    ...
    /**
     * Get API synapse definition artifact from the storage
     * This operation is used to get the API synapse definition from the storage. If the Tenant domain is not provided carbon.super will be picked as the Tenant domain. 
     * @param apiName Name of the API  (required)
     * @param version version of the API  (required)
     * @param tenantDomain Tenant Domain of the API  (optional)
     * @return APIDTO
     ...
     */
    public APIDTO apiArtifactGet(String apiName, String version, String tenantDomain) throws ApiException {
        ApiResponse<APIDTO> resp = apiArtifactGetWithHttpInfo(apiName, version, tenantDomain);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<APIDTO> apiArtifactGetWithHttpInfo(String apiName, String version, String tenantDomain) throws ApiException {
    ...
    /**
     * Get API synapse definition artifact from the storage (asynchronously)
     * This operation is used to get the API synapse definition from the storage. If the Tenant domain is not provided carbon.super will be picked as the Tenant domain. 
     * @param apiName Name of the API  (required)
     * @param version version of the API  (required)
     * @param tenantDomain Tenant Domain of the API  (optional)
     ...
     */
    public com.squareup.okhttp.Call apiArtifactGetAsync(String apiName, String version, String tenantDomain, final ApiCallback<APIDTO> callback) throws ApiException {
