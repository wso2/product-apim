 ...
 * </p>
 */
public class DefaultVersionAPITestCase extends APIManagerIntegrationTest {
    ...
    public void testDefaultVersionAPI() throws Exception{
        ...
        String apiProviderUsername = "admin";
        String apiProviderPassword = "admin";

        //Login to the API Publisher
        apiPublisher.login(apiProviderUsername, apiProviderPassword);
        ...
        APILifeCycleStateRequest updateRequest = new APILifeCycleStateRequest(apiName, apiProviderUsername,
                                                                              APILifeCycleState.PUBLISHED);
        //Publish the API
        apiPublisher.changeAPILifeCycleStatusTo(updateRequest);

        String appDeveloperUsername = "admin";
        String appDeveloperPassword = "admin";

        //Login to the API Store
        apiStore.login(appDeveloperUsername, appDeveloperPassword);

        //Add an Application in the Store.
        apiStore.addApplication("DefaultVersionAPP", "Unlimited", "", "");

        //Subscribe the API to the DefaultApplication
        SubscriptionRequest subscriptionRequest = new SubscriptionRequest(apiName, apiVersion, apiProviderUsername,
        ...
        String directBackEndEndpoint = "http://localhost:8280/response";

        //Going to access the API without the version in the request url.
        String apiInvocationUrl = "http://localhost:8280" + apiContext;
        ...
        Assert.assertEquals(httpResponse.getData(), directResponse.getData(), "Default version API test failed.");
    }
