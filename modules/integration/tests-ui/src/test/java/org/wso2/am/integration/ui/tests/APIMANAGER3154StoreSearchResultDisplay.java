...
public class APIMANAGER3154StoreSearchResultDisplay extends AMIntegrationUiTestBase {
    ...
    public void setUp() throws Exception {
        ...
        publisherURL = "https://" + amServer.getProductVariables().getHostName() + ":" + amServer.getProductVariables().getHttpsPort() + "/publisher";
        storeURL = "https://" + amServer.getProductVariables().getHostName() + ":" + amServer.getProductVariables().getHttpsPort() + "/store";
    }
