...
public class TopicsApi {
     ...
     */
    public okhttp3.Call apisApiIdTopicsGetCall(String apiId, String xWSO2Tenant, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call apisApiIdTopicsGetValidateBeforeCall(String apiId, String xWSO2Tenant, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = apisApiIdTopicsGetCall(apiId, xWSO2Tenant, _callback);
        return localVarCall;
    ...
    public TopicListDTO apisApiIdTopicsGet(String apiId, String xWSO2Tenant) throws ApiException {
        ApiResponse<TopicListDTO> localVarResp = apisApiIdTopicsGetWithHttpInfo(apiId, xWSO2Tenant);
    ...
    public ApiResponse<TopicListDTO> apisApiIdTopicsGetWithHttpInfo(String apiId, String xWSO2Tenant) throws ApiException {
        okhttp3.Call localVarCall = apisApiIdTopicsGetValidateBeforeCall(apiId, xWSO2Tenant, null);
     ...
     */
    public okhttp3.Call apisApiIdTopicsGetAsync(String apiId, String xWSO2Tenant, final ApiCallback<TopicListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = apisApiIdTopicsGetValidateBeforeCall(apiId, xWSO2Tenant, _callback);
        Type localVarReturnType = new TypeToken<TopicListDTO>(){}.getType();
