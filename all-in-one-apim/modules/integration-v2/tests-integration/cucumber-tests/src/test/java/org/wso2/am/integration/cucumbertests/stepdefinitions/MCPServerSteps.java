...
public class MCPServerSteps {
    ...
    public void iReplaceMcpToolsInOrder(String idKey, String newToolSpec, String keptTool, String description)
        ...
        HttpResponse dtoResp = SimpleHTTPClient.getInstance().doGet(Utils.getMCPServerByIdURL(getBaseUrl(), id),
                headers);
        ...
        Requests.put(Utils.getMCPServerByIdURL(getBaseUrl(), id), headers, dto.toString(),
                Constants.CONTENT_TYPES.APPLICATION_JSON);
    }
