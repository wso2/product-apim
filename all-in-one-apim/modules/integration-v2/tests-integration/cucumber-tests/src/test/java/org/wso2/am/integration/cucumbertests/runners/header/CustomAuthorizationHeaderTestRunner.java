...
package org.wso2.am.integration.cucumbertests.runners.header;
...
import org.wso2.am.integration.cucumbertests.runners.publisher.CreateAPITestRunner;
import org.wso2.am.integration.cucumbertests.utils.TestContext;
import org.wso2.am.integration.cucumbertests.utils.TestUser;

@CucumberOptions(
        features = "src/test/resources/features/header/custom_authorization_header.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/createAPI.html"}
)

public class CustomAuthorizationHeaderTestRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String username, String password, String tenantDomain) {
        CustomAuthorizationHeaderTestRunner runner = new CustomAuthorizationHeaderTestRunner();
