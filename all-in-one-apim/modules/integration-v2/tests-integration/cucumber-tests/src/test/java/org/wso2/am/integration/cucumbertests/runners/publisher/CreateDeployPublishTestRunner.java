...
@CucumberOptions(
        features = "src/test/resources/features/publisher/create_deploy_publish_an_api.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/create-deploy-publish.html"}
)
public class CreateDeployPublishTestRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        CreateDeployPublishTestRunner runner = new CreateDeployPublishTestRunner();
