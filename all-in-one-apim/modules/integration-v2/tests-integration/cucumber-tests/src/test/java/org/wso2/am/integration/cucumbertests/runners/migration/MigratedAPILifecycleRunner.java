...
@CucumberOptions(
        features = "src/test/resources/features/migration/migrated_api_lifecycle_management.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/migrated-api-lifecycle.html"}
)

@Test(groups = {"migrationTest"})
public class MigratedAPILifecycleRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        MigratedAPILifecycleRunner runner = new MigratedAPILifecycleRunner();
