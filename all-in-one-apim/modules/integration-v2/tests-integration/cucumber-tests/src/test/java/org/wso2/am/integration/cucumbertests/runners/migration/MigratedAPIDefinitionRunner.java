...
@CucumberOptions(
        features = "src/test/resources/features/migration/migrated_api_definition.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/migrated-api-definition.html"}
)

@Test(groups = {"migrationTest"})
public class MigratedAPIDefinitionRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        MigratedAPIDefinitionRunner runner = new MigratedAPIDefinitionRunner();
