...
@CucumberOptions(
        features = "src/test/resources/features/migration/migrated_api_search.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/migrated-api-search.html"}
)

@Test(groups = {"migrationTest"})
public class MigratedAPISearchRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        MigratedAPISearchRunner runner = new MigratedAPISearchRunner();
