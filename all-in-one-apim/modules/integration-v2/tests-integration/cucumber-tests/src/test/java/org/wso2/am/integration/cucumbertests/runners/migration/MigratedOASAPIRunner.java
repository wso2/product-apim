...
@CucumberOptions(
        features = "src/test/resources/features/migration/migrated_OAS_apis.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/migrated-oas-api.html"}
)

@Test(groups = {"migrationTest"})
public class MigratedOASAPIRunner  extends AbstractTestNGCucumberTests  {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        MigratedOASAPIRunner runner = new MigratedOASAPIRunner();
