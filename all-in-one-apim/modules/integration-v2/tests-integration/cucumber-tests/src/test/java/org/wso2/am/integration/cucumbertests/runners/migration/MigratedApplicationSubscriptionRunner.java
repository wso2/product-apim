...
public class MigratedApplicationSubscriptionRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        MigratedApplicationSubscriptionRunner runner = new MigratedApplicationSubscriptionRunner();
