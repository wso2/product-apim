...
@CucumberOptions(
        features = "src/test/resources/features/publisher/import_OAS_definition.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/import-oas-definition.html"}
)
public class ImportOASDefinitionRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        ImportOASDefinitionRunner runner = new ImportOASDefinitionRunner();
