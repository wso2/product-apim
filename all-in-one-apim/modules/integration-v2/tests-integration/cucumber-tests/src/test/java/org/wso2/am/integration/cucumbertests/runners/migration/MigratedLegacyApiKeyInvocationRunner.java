...
@CucumberOptions(
        features = "src/test/resources/features/migration/migrated_legacy_api_key_invocation.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/migrated-legacy-api-key-invocation.html"}
)

@Test(groups = {"migrationTest"})
public class MigratedLegacyApiKeyInvocationRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        ...
        MigratedLegacyApiKeyInvocationRunner runner = new MigratedLegacyApiKeyInvocationRunner();
