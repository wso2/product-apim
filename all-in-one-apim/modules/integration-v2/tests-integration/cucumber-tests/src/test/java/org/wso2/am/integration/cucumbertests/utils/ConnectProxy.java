...
public final class ConnectProxy implements AutoCloseable {
    ...
    private static final int CONNECT_REQUEST_TIMEOUT_MILLIS = 15000;
    ...
    private void handle(Socket client) {
        ...
        try {
            ...
            client.setSoTimeout(CONNECT_REQUEST_TIMEOUT_MILLIS);
            ...
            // The timeout protects only CONNECT negotiation; an established tunnel may remain idle.
