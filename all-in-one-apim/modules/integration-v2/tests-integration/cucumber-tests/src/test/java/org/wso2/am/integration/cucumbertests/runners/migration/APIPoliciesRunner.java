...
@CucumberOptions(
        features = "src/test/resources/features/migration/api_policies.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/api-policies.html"}
)

@Test(groups = {"migrationTest"})
public class APIPoliciesRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        APIPoliciesRunner runner = new APIPoliciesRunner();
