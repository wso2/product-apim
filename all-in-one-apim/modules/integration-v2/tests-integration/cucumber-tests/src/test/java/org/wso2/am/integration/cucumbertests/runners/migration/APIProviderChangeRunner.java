...
@CucumberOptions(
        features = "src/test/resources/features/migration/api_provider_change.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/api-provider-change.html"}
)

@Test(groups = {"migrationTest"})
public class APIProviderChangeRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        APIProviderChangeRunner runner = new APIProviderChangeRunner();
    ...
    public Object[][] userModeDataProvider() {
        return new Object[][]{
                // Only admin user is authorized for this action
