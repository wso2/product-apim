...
@CucumberOptions(
        features = "src/test/resources/features/migration/new_api_product_from_migrated_apis.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/new-api-product-with-migrated-apis.html"}
)

@Test(groups = {"migrationTest"})
public class NewAPIProductWithMigratedAPIs extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        NewAPIProductWithMigratedAPIs runner = new NewAPIProductWithMigratedAPIs();
