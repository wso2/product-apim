...
@CucumberOptions(
        features = "src/test/resources/features/migration/migrated_shared_scopes.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/migrated-shared-scopes.html"}
)

@Test(groups = {"migrationTest"})
public class MigratedSharedScopesRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        MigratedSharedScopesRunner runner = new MigratedSharedScopesRunner();
    ...
    public Object[][] userModeDataProvider() {
        return new Object[][]{
                // non admin users are not authorized to create/update shared scopes
