...
@CucumberOptions(
        features = {
                "src/test/resources/features/gateway/mediation_policies.feature"
        },
        glue = {
                "org.wso2.am.integration.cucumbertests.stepdefinitions"
        },
        plugin = {"pretty", "html:target/cucumber-report/gateway-mediation-policies.html"}
)
public class GatewayMediationPoliciesRunner extends BaseBlockRunner {
}
