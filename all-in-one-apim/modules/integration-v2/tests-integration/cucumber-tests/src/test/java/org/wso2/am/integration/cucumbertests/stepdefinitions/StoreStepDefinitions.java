...
public class StoreStepDefinitions {
    ...
    public void iCreateAnApplicationWithJsonPayload(String payload) throws IOException {
        ...
        headers.put(Constants.REQUEST_HEADERS.AUTHORIZATION, "Bearer " + context.get("devportalAccessToken").toString());
        ...
        context.set("httpResponse", applicationCreateResponse);
        context.set("createdAppId", Utils.extractValueFromPayload(applicationCreateResponse.getData(), "applicationId"));
    }

    @When("I delete the application with id {string}")
    public void iDeleteApplication(String appId) throws IOException{
        String actualAppId = Utils.resolveFromContext(context, appId).toString();
        Map<String, String> headers = new HashMap<>();
        headers.put(Constants.REQUEST_HEADERS.AUTHORIZATION, "Bearer " + context.get("devportalAccessToken").toString());
        ...
        context.set("httpResponse", applicationDeleteResponse);
    }
    ...
    public void iSubscribeToApi(String apiId, String appId, String payload) throws Exception {
        ...
        context.set("subscriptionId",Utils.extractValueFromPayload(response.getData(), "subscriptionId"));
    ...
    public void iShouldBeAbleToRetrieveApplication(String appId) throws Exception {
        ...
        context.set("httpResponse", applicationRetrieveResponse);
    }
    ...
    public void iGenerateClientCredentialsForApplication(String appId, String payload) throws Exception {
        ...
        context.set("httpResponse", response);
        context.set("consumerKey", Utils.extractValueFromPayload(response.getData(), "consumerKey"));
        context.set("consumerSecret", Utils.extractValueFromPayload(response.getData(), "consumerSecret"));
        context.set("keyMappingId", Utils.extractValueFromPayload(response.getData(), "keyMappingId"));
    }
    ...
    public void iRequestAccessToken(String appId, String payload) throws Exception {
        ...
        String actualAppId = Utils.resolveFromContext(context, appId).toString();
        String keyMappingId = Utils.resolveFromContext(context, "keyMappingId").toString();
        String consumerSecret = Utils.resolveFromContext(context, "consumerSecret").toString();
    ...
    public void iDeleteSubscription(String subscriptionId) throws Exception {
        String actualSubscriptionId = Utils.resolveFromContext(context,subscriptionId).toString();
