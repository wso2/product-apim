...
@CucumberOptions(
        features = {
                "src/test/resources/features/admin/throttling_policy.feature"
        },
        glue = {
                "org.wso2.am.integration.cucumbertests.stepdefinitions"
        },
        plugin = {"pretty", "html:target/cucumber-report/admin-throttling-policy.html"}
)
public class AdminThrottlingPolicyRunner extends BaseBlockRunner {
}
