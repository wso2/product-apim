...
@CucumberOptions(
        features = {
                "src/test/resources/features/publisher/network_access_control_allow.feature"
        },
        glue = {
                "org.wso2.am.integration.cucumbertests.stepdefinitions"
        },
        plugin = {"pretty", "html:target/cucumber-report/publisher-network-access-control-allow.html"}
)
public class NetworkAccessControlAllowRunner extends BaseBlockRunner {
}
