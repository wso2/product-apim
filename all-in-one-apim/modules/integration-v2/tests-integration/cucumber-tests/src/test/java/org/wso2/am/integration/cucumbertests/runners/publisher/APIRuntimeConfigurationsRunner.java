...
@CucumberOptions(
        features = "src/test/resources/features/publisher/api_runtime_configurations.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/api-runtime-configurations.html" }
)
public class APIRuntimeConfigurationsRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        APIRuntimeConfigurationsRunner runner = new APIRuntimeConfigurationsRunner();
