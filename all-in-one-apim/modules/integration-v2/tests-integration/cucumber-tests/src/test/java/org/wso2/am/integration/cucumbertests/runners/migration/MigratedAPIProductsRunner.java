...
@CucumberOptions(
        features = "src/test/resources/features/migration/migrated_api_product.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/migrated-api-products.html"}
)

@Test(groups = {"migrationTest"})
public class MigratedAPIProductsRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        MigratedAPIProductsRunner runner = new MigratedAPIProductsRunner();
