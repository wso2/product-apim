...
@CucumberOptions(
        features = "src/test/resources/features/migration/migrated_api_versioning.feature",
        glue = "org.wso2.am.integration.cucumbertests.stepdefinitions",
        plugin = {"pretty", "html:target/cucumber-report/migrated-api-versioning.html"}
)

@Test(groups = {"migrationTest"})
public class MigratedAPIVersioningRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        MigratedAPIVersioningRunner runner = new MigratedAPIVersioningRunner();
