...
@CucumberOptions(
        features = "src/test/resources/features/migration/legacy_api_key.feature",
...
public class LegacyApiKeyRunner extends AbstractTestNGCucumberTests {
    ...
    public static Object[] factory(String tenantDomain, String userKey) {
        ...
        LegacyApiKeyRunner runner = new LegacyApiKeyRunner();
