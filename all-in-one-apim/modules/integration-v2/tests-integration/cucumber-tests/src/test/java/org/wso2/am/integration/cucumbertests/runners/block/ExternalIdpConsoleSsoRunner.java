 ...
 * headlessly in a real Chromium browser through {@code PlaywrightSsoClient} and its {@code ConnectProxy}, then
 * asserts cross-console single sign-on. The multi-option
