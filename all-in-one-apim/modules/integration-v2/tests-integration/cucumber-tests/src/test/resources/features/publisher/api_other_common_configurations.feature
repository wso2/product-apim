Feature: API Other Common Configurations
 ...
 # Step 3: Update API Resources
  ...
  Scenario Outline: Update Scopes
    ...
    Examples:
      | apiID            |  apiUpdatePayload                 | configType       | configValue                                                                             |
      | RestAPIId        | RestAPIPayload                    |operations        | [{"payloadSchema":null,"operationPolicies":{"request":[],"response":[],"fault":[]},"verb":"POST","uriMapping":null,"throttlingPolicy":"Unlimited","target":"/newlyAddedResource","amznResourceContentEncode":null,"usedProductIds":[],"amznResourceName":null,"id":"","scopes":["new-shared-scope"],"amznResourceTimeout":null,"authType":"Application & Application User","operationHubPolicies":[]}]    |
      | SoapAPIId        | SoapAPIPayload                    |operations        | [{"payloadSchema":null,"operationPolicies":{"request":[],"response":[],"fault":[]},"verb":"POST","uriMapping":null,"throttlingPolicy":"Unlimited","target":"/newlyAddedResource","amznResourceContentEncode":null,"usedProductIds":[],"amznResourceName":null,"id":"","scopes":["new-shared-scope"],"amznResourceTimeout":null,"authType":"Application & Application User","operationHubPolicies":[]}]    |
      | GraphQLAPIId     | graphQLAPIPayload                 |operations        | [{"payloadSchema":null,"operationPolicies":{"request":[],"response":[],"fault":[]},"verb":"QUERY","uriMapping":null,"throttlingPolicy":"Unlimited","target":"newlyAddedResource","amznResourceContentEncode":null,"usedProductIds":[],"amznResourceName":null,"id":"","scopes":["new-shared-scope"],"amznResourceTimeout":null,"authType":"Application & Application User","operationHubPolicies":[]}]    |
      | AsyncAPIId       | AsyncAPIPayload                   |operations        | [{"payloadSchema":null,"operationPolicies":{"request":[],"response":[],"fault":[]},"verb":"SUBSCRIBE","uriMapping":null,"throttlingPolicy":"Unlimited","target":"newlyAddedResource","amznResourceContentEncode":null,"usedProductIds":[],"amznResourceName":null,"id":"","scopes":["new-shared-scope"],"amznResourceTimeout":null,"authType":"Application & Application User","operationHubPolicies":[]}]|
      | RestAPIId        | RestAPIPayload                    |operations        | [{"payloadSchema":null,"operationPolicies":{"request":[],"response":[],"fault":[]},"verb":"POST","uriMapping":null,"throttlingPolicy":"Unlimited","target":"/newlyAddedResource","amznResourceContentEncode":null,"usedProductIds":[],"amznResourceName":null,"id":"","scopes":[],"amznResourceTimeout":null,"authType":"Application & Application User","operationHubPolicies":[]}]        |
      | SoapAPIId        | SoapAPIPayload                    |operations        | [{"payloadSchema":null,"operationPolicies":{"request":[],"response":[],"fault":[]},"verb":"POST","uriMapping":null,"throttlingPolicy":"Unlimited","target":"/newlyAddedResource","amznResourceContentEncode":null,"usedProductIds":[],"amznResourceName":null,"id":"","scopes":[],"amznResourceTimeout":null,"authType":"Application & Application User","operationHubPolicies":[]}]        |
