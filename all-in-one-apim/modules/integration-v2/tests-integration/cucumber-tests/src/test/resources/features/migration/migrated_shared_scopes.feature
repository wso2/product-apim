 ...
 # Step 4: Add migrated and new shared scope to apis
  ...
  Scenario Outline: Add Scopes to resources
    ...
    Examples:
      ...
      | RestAPIId        | RestAPIPayload                    |operations        | [{"payloadSchema":null,"operationPolicies":{"request":[],"response":[],"fault":[]},"verb":"GET","uriMapping":null,"throttlingPolicy":"Unlimited","target":"/customers/{id}","amznResourceContentEncode":null,"usedProductIds":[],"amznResourceName":null,"id":"","scopes":["adp-shared-scope-with-roles"],"amznResourceTimeout":null,"authType":"Application & Application User","operationHubPolicies":[]}]    |
      | migratedAPIId    | migratedAPIPayload                |operations        | [{"payloadSchema":null,"operationPolicies":{"request":[],"response":[],"fault":[]},"verb":"GET","uriMapping":null,"throttlingPolicy":"Unlimited","target":"/customers/{id}","amznResourceContentEncode":null,"usedProductIds":[],"amznResourceName":null,"id":"","scopes":["adp-shared-scope-with-roles"],"amznResourceTimeout":null,"authType":"Application & Application User","operationHubPolicies":[]}, {"payloadSchema":null,"operationPolicies":{"request":[],"response":[],"fault":[]},"verb":"DELETE","uriMapping":null,"throttlingPolicy":"Unlimited","target":"/customers/{id}","amznResourceContentEncode":null,"usedProductIds":[],"amznResourceName":null,"id":"","scopes":["new-shared-scope"],"amznResourceTimeout":null,"authType":"Application & Application User","operationHubPolicies":[]}]  |
