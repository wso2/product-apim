Feature: Migrated API Verification
  ...
  Scenario: Migrated API Retrieval, Update and Invocation
    When I retrieve the API with id "e38d6515-7080-450b-98c6-832dc7a4055d"
    Then The response status code should be 200

    And I get the generated access token from file "features/migration/accessTokens/api_invocation_access_tokens.json"
    And I invoke API of ID "e38d6515-7080-450b-98c6-832dc7a4055d" with path "/customers/123/" and method GET using access token "<generatedAccessToken>"
    Then The response status code should be 200

    And I update API of id "e38d6515-7080-450b-98c6-832dc7a4055d" with the following details
      | description         | Simple Customer Service API description   2                   |
    Then The response status code should be 200

    Then I verify the updated API with id "e38d6515-7080-450b-98c6-832dc7a4055d" has the following api policies
      | request  | custom_add_request_header   |
      | response | custom_add_response_header  |
      | fault    | json_fault                  |
    And I deploy a revision of the API with id "e38d6515-7080-450b-98c6-832dc7a4055d"

    And I get the generated access token from file "features/migration/accessTokens/api_invocation_access_tokens.json"
    And I invoke API of ID "e38d6515-7080-450b-98c6-832dc7a4055d" with path "/customers/123/" and method GET using access token "<generatedAccessToken>"

    And I invoke API of ID "e38d6515-7080-450b-98c6-832dc7a4055d" with path "/check-header" and method GET using access token "<generatedAccessToken>"
    Then The response status code should be 200
