...
public class LabelApi {
     ...
     */
    public okhttp3.Call labelsLabelIdDeleteCall(String labelId, String ifMatch, String ifUnmodifiedSince, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call labelsLabelIdDeleteValidateBeforeCall(String labelId, String ifMatch, String ifUnmodifiedSince, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = labelsLabelIdDeleteCall(labelId, ifMatch, ifUnmodifiedSince, _callback);
        return localVarCall;
    ...
    public ApiResponse<Void> labelsLabelIdDeleteWithHttpInfo(String labelId, String ifMatch, String ifUnmodifiedSince) throws ApiException {
        okhttp3.Call localVarCall = labelsLabelIdDeleteValidateBeforeCall(labelId, ifMatch, ifUnmodifiedSince, null);
     ...
     */
    public okhttp3.Call labelsLabelIdDeleteAsync(String labelId, String ifMatch, String ifUnmodifiedSince, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = labelsLabelIdDeleteValidateBeforeCall(labelId, ifMatch, ifUnmodifiedSince, _callback);
     ...
     */
    public okhttp3.Call labelsLabelIdPutCall(String labelId, LabelDTO labelDTO, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call labelsLabelIdPutValidateBeforeCall(String labelId, LabelDTO labelDTO, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = labelsLabelIdPutCall(labelId, labelDTO, _callback);
        return localVarCall;
    ...
    public LabelDTO labelsLabelIdPut(String labelId, LabelDTO labelDTO) throws ApiException {
        ApiResponse<LabelDTO> localVarResp = labelsLabelIdPutWithHttpInfo(labelId, labelDTO);
    ...
    public ApiResponse<LabelDTO> labelsLabelIdPutWithHttpInfo(String labelId, LabelDTO labelDTO) throws ApiException {
        okhttp3.Call localVarCall = labelsLabelIdPutValidateBeforeCall(labelId, labelDTO, null);
     ...
     */
    public okhttp3.Call labelsLabelIdPutAsync(String labelId, LabelDTO labelDTO, final ApiCallback<LabelDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = labelsLabelIdPutValidateBeforeCall(labelId, labelDTO, _callback);
        Type localVarReturnType = new TypeToken<LabelDTO>(){}.getType();
     ...
     */
    public okhttp3.Call labelsPostCall(LabelDTO labelDTO, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = labelDTO;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call labelsPostValidateBeforeCall(LabelDTO labelDTO, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = labelsPostCall(labelDTO, _callback);
        return localVarCall;
    ...
    public LabelDTO labelsPost(LabelDTO labelDTO) throws ApiException {
        ApiResponse<LabelDTO> localVarResp = labelsPostWithHttpInfo(labelDTO);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<LabelDTO> labelsPostWithHttpInfo(LabelDTO labelDTO) throws ApiException {
        okhttp3.Call localVarCall = labelsPostValidateBeforeCall(labelDTO, null);
        Type localVarReturnType = new TypeToken<LabelDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call labelsPostAsync(LabelDTO labelDTO, final ApiCallback<LabelDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = labelsPostValidateBeforeCall(labelDTO, _callback);
        Type localVarReturnType = new TypeToken<LabelDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
