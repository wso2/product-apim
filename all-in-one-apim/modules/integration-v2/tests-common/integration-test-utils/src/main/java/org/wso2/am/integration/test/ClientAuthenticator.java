    ...
    public static String getAccessToken(String scopeList, String appName, String callBackURL, String tokenScope, String appOwner,
        ...
        try {
            ...
            if (applicationKeyBean == null) {
                DCRParamRequest dcrParamRequest = new DCRParamRequest(appName,callBackURL,tokenScope,appOwner,grantType,dcrEndpoint,username,password,tenantDomain);
                dcrParamRequest.setAppName(appName);
                dcrParamRequest.setCallBackURL(callBackURL);
                dcrParamRequest.setTokenScope(tokenScope);
                dcrParamRequest.setGrantType(grantType);
                dcrParamRequest.setAppOwner(appOwner);
                dcrParamRequest.setUsername(username);
                dcrParamRequest.setPassword(password);
                dcrParamRequest.setTenantDomain(tenantDomain);
                dcrParamRequest.setDcrEndpoint(dcrEndpoint);
