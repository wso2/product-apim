...
public class RestAPIStoreImpl {
    ...
    public RestAPIStoreImpl(String username, String password, String tenantDomain, String storeURL, String containerName) {
        ...
        accessToken = ClientAuthenticator
                .getAccessToken(scopes, appName+containerName, callBackURL, tokenScope, appOwner, grantType, dcrURL, username,
...
//    }
    ...
    private void waitUntilApplicationAvailableInGateway(ApplicationDTO applicationDTO)
        ...
        org.wso2.am.integration.clients.gateway.api.v2.dto.ApplicationInfoDTO applicationInfoDTO = null;
        long retries = 0;
        ...
        while (retries <= 50) {
            try {
                ...
                log.info("Application not yet available in Gateway (retry " + retries + ")");
            }
        ...
        Assert.fail("Application was not available in the Gateway after 20 retries.");
    }
