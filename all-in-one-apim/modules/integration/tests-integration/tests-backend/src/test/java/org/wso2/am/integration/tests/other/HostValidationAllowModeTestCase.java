...
/**
 * Integration tests for host validation with platform-level allow mode (NetworkSecurityAccessControl).
 */
public class HostValidationAllowModeTestCase extends APIMIntegrationBaseTest {
    ...
    @Test(groups = {"wso2.am"},
            description = "Host validation [allow mode]: non-platform-listed URL is blocked by platform allow mode")
    ...
    @Test(groups = {"wso2.am"},
            description = "Host validation [allow mode]: private IP URL is blocked by platform allow mode",
    ...
    @Test(groups = {"wso2.am"},
            description = "Host validation [allow mode]: platform allow mode overrides tenant-level allow mode config",
