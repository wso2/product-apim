...
public class TokenPersistenceExternalIDPJWTTestSuite extends APIManagerLifecycleBaseTest {
    ...
    public void loadConfiguration() throws Exception {
        ...
        serverConfigurationManager.applyConfiguration(new File(getAMResourceLocation()
                + File.separator + "configFiles" + File.separator + "tokenTest" + File.separator + "persistence"
                + File.separator + "externalIdpJwt" + File.separator +  "deployment.toml"));
