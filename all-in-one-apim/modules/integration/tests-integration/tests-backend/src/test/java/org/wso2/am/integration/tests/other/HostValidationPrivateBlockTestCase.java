...
/**
 * Integration tests for host validation with block_private_network_access=true.
 */
public class HostValidationPrivateBlockTestCase extends APIMIntegrationBaseTest {
    ...
    public void testPrivateNetworkBlock_MultipleAPISurfacesBlocked() throws Exception {
        ...
        try {
            restAPIAdmin.addKeyManager(buildKeyManagerDTO("HostValidationLinkLocalKM",
        ...
        try {
            restAPIPublisher.importWSDLSchemaDefinition(null,
                    ...
                    "{\"name\":\"HostValidationLoopbackWSDL\",\"context\":\"/hvloopbackwsdl\","
