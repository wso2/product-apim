...
/**
 * Integration tests for outbound host validation with the feature disabled (no config block present).
 */
public class HostValidationDisabledTestCase extends APIMIntegrationBaseTest {
    ...
    @Test(groups = {"wso2.am"},
            description = "[feature disabled]: all platform checks skipped, nothing blocked")
