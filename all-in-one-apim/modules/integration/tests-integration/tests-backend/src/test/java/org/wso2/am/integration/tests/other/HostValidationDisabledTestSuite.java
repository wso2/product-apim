...
/**
 * Test suite that applies a configuration with no outbound host validation settings, effectively
...
public class HostValidationDisabledTestSuite extends APIManagerLifecycleBaseTest {
    ...
    public void loadConfiguration() throws Exception {
        ...
        serverConfigurationManager.applyConfiguration(new File(getAMResourceLocation()
                + File.separator + "configFiles" + File.separator + "hostValidationDisabled"
