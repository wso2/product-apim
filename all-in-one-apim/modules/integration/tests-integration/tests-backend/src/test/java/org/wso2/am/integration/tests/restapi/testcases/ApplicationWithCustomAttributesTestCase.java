...
public class ApplicationWithCustomAttributesTestCase extends APIMIntegrationBaseTest {

    @Factory(dataProvider = "userModeDataProvider")
    public ApplicationWithCustomAttributesTestCase(TestUserMode userMode) {
    ...
    public void testApplications() {
        ...
        String dataFileName = "ApplicationWithCustomAttributesTestCase.txt";
