...
/**
* APIKeyAssociationListDTO
*/

public class APIKeyAssociationListDTO {
        ...
        @SerializedName(SERIALIZED_NAME_LIST)
            private List<APIKeyAssociationInfoDTO> list = null;


        public APIKeyAssociationListDTO count(Integer count) {
    ...
    /**
        * Number of API key associations returned. 
    * @return count
    **/
        @javax.annotation.Nullable
      @ApiModelProperty(example = "1", value = "Number of API key associations returned. ")
    ...
    public void setCount(Integer count) {
        ...
        public APIKeyAssociationListDTO list(List<APIKeyAssociationInfoDTO> list) {
    ...
    **/
    ...
    public List<APIKeyAssociationInfoDTO> getList() {
        return list;
    }


    public void setList(List<APIKeyAssociationInfoDTO> list) {
        this.list = list;
    }
    ...
    public boolean equals(Object o) {
        ...
        return false;
            ...
            APIKeyAssociationListDTO apIKeyAssociationList = (APIKeyAssociationListDTO) o;
            return Objects.equals(this.count, apIKeyAssociationList.count) &&
            Objects.equals(this.list, apIKeyAssociationList.list);
    }
...
sb.append("class APIKeyAssociationListDTO {\n");
