...
public class McpServerDocumentsApi {
     ...
     */
    public okhttp3.Call getMCPServerDocumentCall(String mcpServerId, String documentId, String xWSO2Tenant, String ifNoneMatch, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getMCPServerDocumentValidateBeforeCall(String mcpServerId, String documentId, String xWSO2Tenant, String ifNoneMatch, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getMCPServerDocumentCall(mcpServerId, documentId, xWSO2Tenant, ifNoneMatch, _callback);
        return localVarCall;
     ...
     */
    public DocumentDTO getMCPServerDocument(String mcpServerId, String documentId, String xWSO2Tenant, String ifNoneMatch) throws ApiException {
        ApiResponse<DocumentDTO> localVarResp = getMCPServerDocumentWithHttpInfo(mcpServerId, documentId, xWSO2Tenant, ifNoneMatch);
     ...
     */
    public ApiResponse<DocumentDTO> getMCPServerDocumentWithHttpInfo(String mcpServerId, String documentId, String xWSO2Tenant, String ifNoneMatch) throws ApiException {
        okhttp3.Call localVarCall = getMCPServerDocumentValidateBeforeCall(mcpServerId, documentId, xWSO2Tenant, ifNoneMatch, null);
     ...
     */
    public okhttp3.Call getMCPServerDocumentAsync(String mcpServerId, String documentId, String xWSO2Tenant, String ifNoneMatch, final ApiCallback<DocumentDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMCPServerDocumentValidateBeforeCall(mcpServerId, documentId, xWSO2Tenant, ifNoneMatch, _callback);
        Type localVarReturnType = new TypeToken<DocumentDTO>(){}.getType();
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK. File or inline content returned.  </td><td>  * ETag - Entity Tag of the response resource. Used by caches, or in conditional requests.  <br>  * Last-Modified - Date and time the resource has been modified the last time. Used by caches, or in conditional requests.  <br>  </td></tr>
     ...
     */
    public okhttp3.Call getMCPServerDocumentContentCall(String mcpServerId, String documentId, String xWSO2Tenant, String ifNoneMatch, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMCPServerDocumentContentValidateBeforeCall(String mcpServerId, String documentId, String xWSO2Tenant, String ifNoneMatch, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getMCPServerDocumentContentCall(mcpServerId, documentId, xWSO2Tenant, ifNoneMatch, _callback);
        return localVarCall;
     ...
     */
    public void getMCPServerDocumentContent(String mcpServerId, String documentId, String xWSO2Tenant, String ifNoneMatch) throws ApiException {
        getMCPServerDocumentContentWithHttpInfo(mcpServerId, documentId, xWSO2Tenant, ifNoneMatch);
    }
     ...
     */
    public ApiResponse<Void> getMCPServerDocumentContentWithHttpInfo(String mcpServerId, String documentId, String xWSO2Tenant, String ifNoneMatch) throws ApiException {
        okhttp3.Call localVarCall = getMCPServerDocumentContentValidateBeforeCall(mcpServerId, documentId, xWSO2Tenant, ifNoneMatch, null);
     ...
     */
    public okhttp3.Call getMCPServerDocumentContentAsync(String mcpServerId, String documentId, String xWSO2Tenant, String ifNoneMatch, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMCPServerDocumentContentValidateBeforeCall(mcpServerId, documentId, xWSO2Tenant, ifNoneMatch, _callback);
     ...
     */
    public okhttp3.Call getMCPServerDocumentsCall(String mcpServerId, Integer limit, Integer offset, String xWSO2Tenant, String ifNoneMatch, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMCPServerDocumentsValidateBeforeCall(String mcpServerId, Integer limit, Integer offset, String xWSO2Tenant, String ifNoneMatch, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getMCPServerDocumentsCall(mcpServerId, limit, offset, xWSO2Tenant, ifNoneMatch, _callback);
        return localVarCall;
     ...
     */
    public DocumentListDTO getMCPServerDocuments(String mcpServerId, Integer limit, Integer offset, String xWSO2Tenant, String ifNoneMatch) throws ApiException {
        ApiResponse<DocumentListDTO> localVarResp = getMCPServerDocumentsWithHttpInfo(mcpServerId, limit, offset, xWSO2Tenant, ifNoneMatch);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<DocumentListDTO> getMCPServerDocumentsWithHttpInfo(String mcpServerId, Integer limit, Integer offset, String xWSO2Tenant, String ifNoneMatch) throws ApiException {
        okhttp3.Call localVarCall = getMCPServerDocumentsValidateBeforeCall(mcpServerId, limit, offset, xWSO2Tenant, ifNoneMatch, null);
     ...
     */
    public okhttp3.Call getMCPServerDocumentsAsync(String mcpServerId, Integer limit, Integer offset, String xWSO2Tenant, String ifNoneMatch, final ApiCallback<DocumentListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMCPServerDocumentsValidateBeforeCall(mcpServerId, limit, offset, xWSO2Tenant, ifNoneMatch, _callback);
        Type localVarReturnType = new TypeToken<DocumentListDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
