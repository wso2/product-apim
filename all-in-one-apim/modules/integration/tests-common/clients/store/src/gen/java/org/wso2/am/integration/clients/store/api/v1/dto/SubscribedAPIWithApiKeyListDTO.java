...
import org.wso2.am.integration.clients.store.api.v1.dto.APIWithKeyInfoDTO;
import com.fasterxml.jackson.annotation.JsonCreator;
/**
* SubscribedAPIWithApiKeyListDTO
*/

public class SubscribedAPIWithApiKeyListDTO {
        ...
        @SerializedName(SERIALIZED_NAME_LIST)
            private List<APIWithKeyInfoDTO> list = null;


        public SubscribedAPIWithApiKeyListDTO count(Integer count) {
    ...
    /**
        * Number of subscribed APIs with API keys returned. 
    * @return count
    **/
        @javax.annotation.Nullable
      @ApiModelProperty(example = "1", value = "Number of subscribed APIs with API keys returned. ")
    ...
    public void setCount(Integer count) {
        ...
        public SubscribedAPIWithApiKeyListDTO list(List<APIWithKeyInfoDTO> list) {
    ...
    **/
    ...
    public List<APIWithKeyInfoDTO> getList() {
        return list;
    }


    public void setList(List<APIWithKeyInfoDTO> list) {
        this.list = list;
    }
    ...
    public boolean equals(Object o) {
        ...
        return false;
            ...
            SubscribedAPIWithApiKeyListDTO subscribedAPIWithApiKeyList = (SubscribedAPIWithApiKeyListDTO) o;
            return Objects.equals(this.count, subscribedAPIWithApiKeyList.count) &&
            Objects.equals(this.list, subscribedAPIWithApiKeyList.list);
    }
...
sb.append("class SubscribedAPIWithApiKeyListDTO {\n");
