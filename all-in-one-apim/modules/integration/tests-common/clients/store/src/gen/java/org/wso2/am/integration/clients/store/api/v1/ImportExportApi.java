...
public class ImportExportApi {
     ...
     */
    public okhttp3.Call applicationsExportGetCall(String appName, String appOwner, Boolean withKeys, String format, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/applications/export";
    ...
    private okhttp3.Call applicationsExportGetValidateBeforeCall(String appName, String appOwner, Boolean withKeys, String format, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'appName' is set
        if (appName == null) {
            throw new ApiException("Missing the required parameter 'appName' when calling applicationsExportGet(Async)");
        }
        
        // verify the required parameter 'appOwner' is set
        if (appOwner == null) {
            throw new ApiException("Missing the required parameter 'appOwner' when calling applicationsExportGet(Async)");
        }
        

        okhttp3.Call localVarCall = applicationsExportGetCall(appName, appOwner, withKeys, format, _callback);
        return localVarCall;
     ...
     */
    public File applicationsExportGet(String appName, String appOwner, Boolean withKeys, String format) throws ApiException {
        ApiResponse<File> localVarResp = applicationsExportGetWithHttpInfo(appName, appOwner, withKeys, format);
     ...
     */
    public ApiResponse<File> applicationsExportGetWithHttpInfo(String appName, String appOwner, Boolean withKeys, String format) throws ApiException {
        okhttp3.Call localVarCall = applicationsExportGetValidateBeforeCall(appName, appOwner, withKeys, format, null);
     ...
     */
    public okhttp3.Call applicationsExportGetAsync(String appName, String appOwner, Boolean withKeys, String format, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = applicationsExportGetValidateBeforeCall(appName, appOwner, withKeys, format, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
