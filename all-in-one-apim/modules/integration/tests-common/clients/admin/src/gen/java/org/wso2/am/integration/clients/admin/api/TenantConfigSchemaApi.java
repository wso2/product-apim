...
public class TenantConfigSchemaApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> OK. Tenant config schema exported successfully.  </td><td>  * Content-Type - The content type of the body.  <br>  </td></tr>
     ...
     */
    public okhttp3.Call exportTenantConfigSchemaCall(final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/tenant-config-schema";
    ...
    private okhttp3.Call exportTenantConfigSchemaValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = exportTenantConfigSchemaCall(_callback);
        return localVarCall;
     ...
     */
    public String exportTenantConfigSchema() throws ApiException {
        ApiResponse<String> localVarResp = exportTenantConfigSchemaWithHttpInfo();
     ...
     */
    public ApiResponse<String> exportTenantConfigSchemaWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = exportTenantConfigSchemaValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Export a tenant-Config-Schema. (asynchronously)
     * This operation can be used to export a tenant-config-schema.json used in deployment. 
     ...
     */
    public okhttp3.Call exportTenantConfigSchemaAsync(final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = exportTenantConfigSchemaValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
