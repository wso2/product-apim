...
public class TenantConfigApi {
     ...
     */
    public okhttp3.Call updateTenantConfigCall(String body, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateTenantConfigValidateBeforeCall(String body, final ApiCallback _callback) throws ApiException {
     ...
     */
    public Object updateTenantConfig(String body) throws ApiException {
     ...
     */
    public ApiResponse<Object> updateTenantConfigWithHttpInfo(String body) throws ApiException {
     ...
     */
    public okhttp3.Call updateTenantConfigAsync(String body, final ApiCallback<Object> _callback) throws ApiException {
