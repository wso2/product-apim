...
public class LlmProvidersApi {
     ...
     */
    @Deprecated
    public okhttp3.Call addLLMProviderCall(String name, String apiVersion, String description, String configurations, File apiDefinition, String modelList, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call addLLMProviderValidateBeforeCall(String name, String apiVersion, String description, String configurations, File apiDefinition, String modelList, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = addLLMProviderCall(name, apiVersion, description, configurations, apiDefinition, modelList, _callback);
        return localVarCall;
     ...
     */
    @Deprecated
    public LLMProviderResponseDTO addLLMProvider(String name, String apiVersion, String description, String configurations, File apiDefinition, String modelList) throws ApiException {
        ApiResponse<LLMProviderResponseDTO> localVarResp = addLLMProviderWithHttpInfo(name, apiVersion, description, configurations, apiDefinition, modelList);
     ...
     */
    @Deprecated
    public ApiResponse<LLMProviderResponseDTO> addLLMProviderWithHttpInfo(String name, String apiVersion, String description, String configurations, File apiDefinition, String modelList) throws ApiException {
        okhttp3.Call localVarCall = addLLMProviderValidateBeforeCall(name, apiVersion, description, configurations, apiDefinition, modelList, null);
     ...
     */
    @Deprecated
    public okhttp3.Call addLLMProviderAsync(String name, String apiVersion, String description, String configurations, File apiDefinition, String modelList, final ApiCallback<LLMProviderResponseDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = addLLMProviderValidateBeforeCall(name, apiVersion, description, configurations, apiDefinition, modelList, _callback);
        Type localVarReturnType = new TypeToken<LLMProviderResponseDTO>(){}.getType();
