...
public class CustomRulesCollectionApi {
     ...
     */
    public okhttp3.Call throttlingPoliciesCustomGetCall(String accept, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call throttlingPoliciesCustomGetValidateBeforeCall(String accept, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = throttlingPoliciesCustomGetCall(accept, _callback);
        return localVarCall;
     ...
     */
    public CustomRuleListDTO throttlingPoliciesCustomGet(String accept) throws ApiException {
        ApiResponse<CustomRuleListDTO> localVarResp = throttlingPoliciesCustomGetWithHttpInfo(accept);
     ...
     */
    public ApiResponse<CustomRuleListDTO> throttlingPoliciesCustomGetWithHttpInfo(String accept) throws ApiException {
        okhttp3.Call localVarCall = throttlingPoliciesCustomGetValidateBeforeCall(accept, null);
     ...
     */
    public okhttp3.Call throttlingPoliciesCustomGetAsync(String accept, final ApiCallback<CustomRuleListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = throttlingPoliciesCustomGetValidateBeforeCall(accept, _callback);
        Type localVarReturnType = new TypeToken<CustomRuleListDTO>(){}.getType();
