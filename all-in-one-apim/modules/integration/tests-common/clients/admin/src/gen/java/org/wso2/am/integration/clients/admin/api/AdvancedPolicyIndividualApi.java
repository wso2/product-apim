...
public class AdvancedPolicyIndividualApi {
     ...
     */
    public okhttp3.Call throttlingPoliciesAdvancedPolicyIdDeleteCall(String policyId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call throttlingPoliciesAdvancedPolicyIdDeleteValidateBeforeCall(String policyId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = throttlingPoliciesAdvancedPolicyIdDeleteCall(policyId, _callback);
        return localVarCall;
     ...
     */
    public void throttlingPoliciesAdvancedPolicyIdDelete(String policyId) throws ApiException {
        throttlingPoliciesAdvancedPolicyIdDeleteWithHttpInfo(policyId);
    }
     ...
     */
    public ApiResponse<Void> throttlingPoliciesAdvancedPolicyIdDeleteWithHttpInfo(String policyId) throws ApiException {
        okhttp3.Call localVarCall = throttlingPoliciesAdvancedPolicyIdDeleteValidateBeforeCall(policyId, null);
     ...
     */
    public okhttp3.Call throttlingPoliciesAdvancedPolicyIdDeleteAsync(String policyId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = throttlingPoliciesAdvancedPolicyIdDeleteValidateBeforeCall(policyId, _callback);
     ...
     */
    public okhttp3.Call throttlingPoliciesAdvancedPolicyIdGetCall(String policyId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call throttlingPoliciesAdvancedPolicyIdGetValidateBeforeCall(String policyId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = throttlingPoliciesAdvancedPolicyIdGetCall(policyId, _callback);
        return localVarCall;
     ...
     */
    public AdvancedThrottlePolicyDTO throttlingPoliciesAdvancedPolicyIdGet(String policyId) throws ApiException {
        ApiResponse<AdvancedThrottlePolicyDTO> localVarResp = throttlingPoliciesAdvancedPolicyIdGetWithHttpInfo(policyId);
     ...
     */
    public ApiResponse<AdvancedThrottlePolicyDTO> throttlingPoliciesAdvancedPolicyIdGetWithHttpInfo(String policyId) throws ApiException {
        okhttp3.Call localVarCall = throttlingPoliciesAdvancedPolicyIdGetValidateBeforeCall(policyId, null);
     ...
     */
    public okhttp3.Call throttlingPoliciesAdvancedPolicyIdGetAsync(String policyId, final ApiCallback<AdvancedThrottlePolicyDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = throttlingPoliciesAdvancedPolicyIdGetValidateBeforeCall(policyId, _callback);
        Type localVarReturnType = new TypeToken<AdvancedThrottlePolicyDTO>(){}.getType();
     ...
     */
    public okhttp3.Call throttlingPoliciesAdvancedPolicyIdPutCall(String policyId, String contentType, AdvancedThrottlePolicyDTO advancedThrottlePolicyDTO, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call throttlingPoliciesAdvancedPolicyIdPutValidateBeforeCall(String policyId, String contentType, AdvancedThrottlePolicyDTO advancedThrottlePolicyDTO, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = throttlingPoliciesAdvancedPolicyIdPutCall(policyId, contentType, advancedThrottlePolicyDTO, _callback);
        return localVarCall;
     ...
     */
    public AdvancedThrottlePolicyDTO throttlingPoliciesAdvancedPolicyIdPut(String policyId, String contentType, AdvancedThrottlePolicyDTO advancedThrottlePolicyDTO) throws ApiException {
        ApiResponse<AdvancedThrottlePolicyDTO> localVarResp = throttlingPoliciesAdvancedPolicyIdPutWithHttpInfo(policyId, contentType, advancedThrottlePolicyDTO);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AdvancedThrottlePolicyDTO> throttlingPoliciesAdvancedPolicyIdPutWithHttpInfo(String policyId, String contentType, AdvancedThrottlePolicyDTO advancedThrottlePolicyDTO) throws ApiException {
        okhttp3.Call localVarCall = throttlingPoliciesAdvancedPolicyIdPutValidateBeforeCall(policyId, contentType, advancedThrottlePolicyDTO, null);
        Type localVarReturnType = new TypeToken<AdvancedThrottlePolicyDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call throttlingPoliciesAdvancedPolicyIdPutAsync(String policyId, String contentType, AdvancedThrottlePolicyDTO advancedThrottlePolicyDTO, final ApiCallback<AdvancedThrottlePolicyDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = throttlingPoliciesAdvancedPolicyIdPutValidateBeforeCall(policyId, contentType, advancedThrottlePolicyDTO, _callback);
        Type localVarReturnType = new TypeToken<AdvancedThrottlePolicyDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
