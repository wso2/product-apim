...
import org.wso2.am.integration.clients.admin.api.dto.WorkflowResponseDTO;
...
public class ApplicationsApi {
     ...
     */
    public okhttp3.Call applicationsApplicationIdDeleteCall(String applicationId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call applicationsApplicationIdDeleteValidateBeforeCall(String applicationId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = applicationsApplicationIdDeleteCall(applicationId, _callback);
        return localVarCall;
     ...
     */
    public void applicationsApplicationIdDelete(String applicationId) throws ApiException {
        applicationsApplicationIdDeleteWithHttpInfo(applicationId);
    }
     ...
     */
    public ApiResponse<Void> applicationsApplicationIdDeleteWithHttpInfo(String applicationId) throws ApiException {
        okhttp3.Call localVarCall = applicationsApplicationIdDeleteValidateBeforeCall(applicationId, null);
     ...
     */
    public okhttp3.Call applicationsApplicationIdDeleteAsync(String applicationId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = applicationsApplicationIdDeleteValidateBeforeCall(applicationId, _callback);
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK. Application details returned.  </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Bad Request. Invalid request or validation error. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Not Found. The specified resource does not exist. </td><td>  -  </td></tr>
        <tr><td> 406 </td><td> Not Acceptable. The requested media type is not supported. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call applicationsApplicationIdGetCall(String applicationId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call applicationsApplicationIdGetValidateBeforeCall(String applicationId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = applicationsApplicationIdGetCall(applicationId, _callback);
        return localVarCall;
     ...
     */
    public ApplicationDTO applicationsApplicationIdGet(String applicationId) throws ApiException {
        ApiResponse<ApplicationDTO> localVarResp = applicationsApplicationIdGetWithHttpInfo(applicationId);
     ...
     */
    public ApiResponse<ApplicationDTO> applicationsApplicationIdGetWithHttpInfo(String applicationId) throws ApiException {
        okhttp3.Call localVarCall = applicationsApplicationIdGetValidateBeforeCall(applicationId, null);
        Type localVarReturnType = new TypeToken<ApplicationDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get the details of an Application  (asynchronously)
     * This operation can be used to get the details of an application by specifying its id. 
     * @param applicationId Application UUID  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call applicationsApplicationIdGetAsync(String applicationId, final ApiCallback<ApplicationDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = applicationsApplicationIdGetValidateBeforeCall(applicationId, _callback);
        Type localVarReturnType = new TypeToken<ApplicationDTO>(){}.getType();
