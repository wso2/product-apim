...
public class LlmProviderApi {
    ...
    public okhttp3.Call deleteLLMProviderCall(String llmProviderId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/llm-providers/{llmProviderId}"
     ...
     * Delete a LLM Provider by llmProviderId 
     * @param llmProviderId LLM Provider UUID  (required)
    ...
    /**
     * Delete a LLM Provider (asynchronously)
     * Delete a LLM Provider by llmProviderId 
     * @param llmProviderId LLM Provider UUID  (required)
    ...
    /**
     * Get LLM Provider (asynchronously)
     * Get a LLM Provider 
     * @param llmProviderId LLM Provider UUID  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK. LLM Provider updated.  </td><td>  -  </td></tr>
     ...
     * Update a LLM provider by LLMProviderId 
     * @param llmProviderId LLM Provider UUID  (required)
     * @param name  (optional)
     * @param apiVersion  (optional)
     * @param description  (optional)
    ...
    /**
     * Update an LLM provider (asynchronously)
     * Update a LLM provider by LLMProviderId 
     * @param llmProviderId LLM Provider UUID  (required)
     * @param name  (optional)
     * @param apiVersion  (optional)
