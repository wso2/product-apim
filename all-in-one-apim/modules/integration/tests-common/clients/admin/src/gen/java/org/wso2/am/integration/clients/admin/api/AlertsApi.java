...
public class AlertsApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> OK. The list of admin alert types are returned.  </td><td>  * Content-Type - The content type of the body.  <br>  </td></tr>
        <tr><td> 500 </td><td> Internal Server Error. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getAdminAlertTypesCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAdminAlertTypesValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAdminAlertTypesCall(_callback);
        return localVarCall;
    ...
    public AlertTypesListDTO getAdminAlertTypes() throws ApiException {
        ApiResponse<AlertTypesListDTO> localVarResp = getAdminAlertTypesWithHttpInfo();
    ...
    public ApiResponse<AlertTypesListDTO> getAdminAlertTypesWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getAdminAlertTypesValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call getAdminAlertTypesAsync(final ApiCallback<AlertTypesListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAdminAlertTypesValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<AlertTypesListDTO>(){}.getType();
