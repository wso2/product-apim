...
public class ApplicationPolicyCollectionApi {
     ...
     */
    public okhttp3.Call throttlingPoliciesApplicationGetCall(String accept, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call throttlingPoliciesApplicationGetValidateBeforeCall(String accept, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = throttlingPoliciesApplicationGetCall(accept, _callback);
        return localVarCall;
     ...
     */
    public ApplicationThrottlePolicyListDTO throttlingPoliciesApplicationGet(String accept) throws ApiException {
        ApiResponse<ApplicationThrottlePolicyListDTO> localVarResp = throttlingPoliciesApplicationGetWithHttpInfo(accept);
     ...
     */
    public ApiResponse<ApplicationThrottlePolicyListDTO> throttlingPoliciesApplicationGetWithHttpInfo(String accept) throws ApiException {
        okhttp3.Call localVarCall = throttlingPoliciesApplicationGetValidateBeforeCall(accept, null);
     ...
     */
    public okhttp3.Call throttlingPoliciesApplicationGetAsync(String accept, final ApiCallback<ApplicationThrottlePolicyListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = throttlingPoliciesApplicationGetValidateBeforeCall(accept, _callback);
        Type localVarReturnType = new TypeToken<ApplicationThrottlePolicyListDTO>(){}.getType();
     ...
     * @param applicationThrottlePolicyDTO Application level policy object that should to be added  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call throttlingPoliciesApplicationPostCall(String contentType, ApplicationThrottlePolicyDTO applicationThrottlePolicyDTO, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call throttlingPoliciesApplicationPostValidateBeforeCall(String contentType, ApplicationThrottlePolicyDTO applicationThrottlePolicyDTO, final ApiCallback _callback) throws ApiException {
        ...
        if (applicationThrottlePolicyDTO == null) {
            throw new ApiException("Missing the required parameter 'applicationThrottlePolicyDTO' when calling throttlingPoliciesApplicationPost(Async)");
        }
        

        okhttp3.Call localVarCall = throttlingPoliciesApplicationPostCall(contentType, applicationThrottlePolicyDTO, _callback);
        return localVarCall;
    ...
    public ApplicationThrottlePolicyDTO throttlingPoliciesApplicationPost(String contentType, ApplicationThrottlePolicyDTO applicationThrottlePolicyDTO) throws ApiException {
        ApiResponse<ApplicationThrottlePolicyDTO> localVarResp = throttlingPoliciesApplicationPostWithHttpInfo(contentType, applicationThrottlePolicyDTO);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<ApplicationThrottlePolicyDTO> throttlingPoliciesApplicationPostWithHttpInfo(String contentType, ApplicationThrottlePolicyDTO applicationThrottlePolicyDTO) throws ApiException {
        okhttp3.Call localVarCall = throttlingPoliciesApplicationPostValidateBeforeCall(contentType, applicationThrottlePolicyDTO, null);
     ...
     */
    public okhttp3.Call throttlingPoliciesApplicationPostAsync(String contentType, ApplicationThrottlePolicyDTO applicationThrottlePolicyDTO, final ApiCallback<ApplicationThrottlePolicyDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = throttlingPoliciesApplicationPostValidateBeforeCall(contentType, applicationThrottlePolicyDTO, _callback);
        Type localVarReturnType = new TypeToken<ApplicationThrottlePolicyDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
