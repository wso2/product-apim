...
import org.wso2.am.integration.clients.admin.api.dto.SearchResultListDTO;
...
public class ApIsApi {
     ...
     * @param query **Search and get all apis in admin portal**.  You can search by proving a keyword.  (optional)
     ...
     */
    public okhttp3.Call getAllAPIsCall(Integer limit, Integer offset, String query, String ifNoneMatch, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllAPIsValidateBeforeCall(Integer limit, Integer offset, String query, String ifNoneMatch, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAllAPIsCall(limit, offset, query, ifNoneMatch, _callback);
        return localVarCall;
    ...
    public SearchResultListDTO getAllAPIs(Integer limit, Integer offset, String query, String ifNoneMatch) throws ApiException {
        ApiResponse<SearchResultListDTO> localVarResp = getAllAPIsWithHttpInfo(limit, offset, query, ifNoneMatch);
    ...
    public ApiResponse<SearchResultListDTO> getAllAPIsWithHttpInfo(Integer limit, Integer offset, String query, String ifNoneMatch) throws ApiException {
        okhttp3.Call localVarCall = getAllAPIsValidateBeforeCall(limit, offset, query, ifNoneMatch, null);
     ...
     */
    public okhttp3.Call getAllAPIsAsync(Integer limit, Integer offset, String query, String ifNoneMatch, final ApiCallback<SearchResultListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllAPIsValidateBeforeCall(limit, offset, query, ifNoneMatch, _callback);
        Type localVarReturnType = new TypeToken<SearchResultListDTO>(){}.getType();
