...
public class GlobalKeyManagerCollectionApi {
    private ApiClient localVarApiClient;

    public GlobalKeyManagerCollectionApi() {
        this(Configuration.getDefaultApiClient());
    }

    public GlobalKeyManagerCollectionApi(ApiClient apiClient) {
    ...
    /**
     * Build call for globalKeyManagersGet
     ...
     */
    public okhttp3.Call globalKeyManagersGetCall(final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/global-key-managers";
    ...
    private okhttp3.Call globalKeyManagersGetValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = globalKeyManagersGetCall(_callback);
        return localVarCall;
     ...
     */
    public KeyManagerListDTO globalKeyManagersGet() throws ApiException {
        ApiResponse<KeyManagerListDTO> localVarResp = globalKeyManagersGetWithHttpInfo();
     ...
     */
    public ApiResponse<KeyManagerListDTO> globalKeyManagersGetWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = globalKeyManagersGetValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<KeyManagerListDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get all Global Key managers (asynchronously)
     * Get all Global Key managers 
     ...
     */
    public okhttp3.Call globalKeyManagersGetAsync(final ApiCallback<KeyManagerListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = globalKeyManagersGetValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<KeyManagerListDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for globalKeyManagersPost
     ...
     */
    public okhttp3.Call globalKeyManagersPostCall(KeyManagerDTO keyManagerDTO, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call globalKeyManagersPostValidateBeforeCall(KeyManagerDTO keyManagerDTO, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'keyManagerDTO' is set
        if (keyManagerDTO == null) {
            throw new ApiException("Missing the required parameter 'keyManagerDTO' when calling globalKeyManagersPost(Async)");
        }
        

        okhttp3.Call localVarCall = globalKeyManagersPostCall(keyManagerDTO, _callback);
        return localVarCall;
     ...
     */
    public KeyManagerDTO globalKeyManagersPost(KeyManagerDTO keyManagerDTO) throws ApiException {
        ApiResponse<KeyManagerDTO> localVarResp = globalKeyManagersPostWithHttpInfo(keyManagerDTO);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<KeyManagerDTO> globalKeyManagersPostWithHttpInfo(KeyManagerDTO keyManagerDTO) throws ApiException {
        okhttp3.Call localVarCall = globalKeyManagersPostValidateBeforeCall(keyManagerDTO, null);
        Type localVarReturnType = new TypeToken<KeyManagerDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Add a new Global Key Manager (asynchronously)
     * Add a new Global Key Manager 
     * @param keyManagerDTO Key Manager object that should to be added  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call globalKeyManagersPostAsync(KeyManagerDTO keyManagerDTO, final ApiCallback<KeyManagerDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = globalKeyManagersPostValidateBeforeCall(keyManagerDTO, _callback);
        Type localVarReturnType = new TypeToken<KeyManagerDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
