...
public class ApiProviderChangeApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> OK. Api Provider updated.  </td><td>  * Content-Type - The content type of the body.  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad Request. Invalid request or validation error. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Not Found. The specified resource does not exist. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call providerNamePostCall(String provider, String apiId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/apis/{apiId}/change-provider"
    ...
    private okhttp3.Call providerNamePostValidateBeforeCall(String provider, String apiId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = providerNamePostCall(provider, apiId, _callback);
        return localVarCall;
    ...
    public void providerNamePost(String provider, String apiId) throws ApiException {
        providerNamePostWithHttpInfo(provider, apiId);
    }
    ...
    public ApiResponse<Void> providerNamePostWithHttpInfo(String provider, String apiId) throws ApiException {
        okhttp3.Call localVarCall = providerNamePostValidateBeforeCall(provider, apiId, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Update the api provider (asynchronously)
     * Update the api provider 
     * @param provider  (required)
     * @param apiId **API ID** consisting of the **UUID** of the API.  (required)
     ...
     */
    public okhttp3.Call providerNamePostAsync(String provider, String apiId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = providerNamePostValidateBeforeCall(provider, apiId, _callback);
