...
public class ConsumptionApi {
    ...
    /**
     * Build call for exportConsumptionData
     * @param fromDate Start date of the export range (inclusive). Format: YYYY-MM-DD.  (required)
     * @param toDate End date of the export range (inclusive). Format: YYYY-MM-DD.  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> OK. Consumption data exported successfully as a ZIP file.  </td><td>  * Content-Disposition - Indicates the filename for the download (e.g., consumption-report.zip).  <br>  * Content-Type - The content type of the body. <br>  </td></tr>
     ...
     */
    public okhttp3.Call exportConsumptionDataCall(String fromDate, String toDate, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/export-consumption";
    ...
    private okhttp3.Call exportConsumptionDataValidateBeforeCall(String fromDate, String toDate, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'fromDate' is set
        if (fromDate == null) {
            throw new ApiException("Missing the required parameter 'fromDate' when calling exportConsumptionData(Async)");
        }
        
        // verify the required parameter 'toDate' is set
        if (toDate == null) {
            throw new ApiException("Missing the required parameter 'toDate' when calling exportConsumptionData(Async)");
        }
        

        okhttp3.Call localVarCall = exportConsumptionDataCall(fromDate, toDate, _callback);
        return localVarCall;
     ...
     * This operation provides a ZIP archive containing API consumption/usage data for a given date range. 
     * @param fromDate Start date of the export range (inclusive). Format: YYYY-MM-DD.  (required)
     * @param toDate End date of the export range (inclusive). Format: YYYY-MM-DD.  (required)
     * @return File
     ...
     */
    public File exportConsumptionData(String fromDate, String toDate) throws ApiException {
        ApiResponse<File> localVarResp = exportConsumptionDataWithHttpInfo(fromDate, toDate);
     ...
     */
    public ApiResponse<File> exportConsumptionDataWithHttpInfo(String fromDate, String toDate) throws ApiException {
        okhttp3.Call localVarCall = exportConsumptionDataValidateBeforeCall(fromDate, toDate, null);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Export API Consumption Data  (asynchronously)
     * This operation provides a ZIP archive containing API consumption/usage data for a given date range. 
     * @param fromDate Start date of the export range (inclusive). Format: YYYY-MM-DD.  (required)
     * @param toDate End date of the export range (inclusive). Format: YYYY-MM-DD.  (required)
     ...
     */
    public okhttp3.Call exportConsumptionDataAsync(String fromDate, String toDate, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = exportConsumptionDataValidateBeforeCall(fromDate, toDate, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
