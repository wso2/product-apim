...
public class LabelsCollectionApi {
    private ApiClient localVarApiClient;

    public LabelsCollectionApi() {
        this(Configuration.getDefaultApiClient());
    }

    public LabelsCollectionApi(ApiClient apiClient) {
     ...
     */
    public okhttp3.Call getAllLabelsCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllLabelsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAllLabelsCall(_callback);
        return localVarCall;
     ...
     */
    public LabelListDTO getAllLabels() throws ApiException {
        ApiResponse<LabelListDTO> localVarResp = getAllLabelsWithHttpInfo();
     ...
     */
    public ApiResponse<LabelListDTO> getAllLabelsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getAllLabelsValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call getAllLabelsAsync(final ApiCallback<LabelListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllLabelsValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<LabelListDTO>(){}.getType();
