...
public class UnifiedSearchApi {
     ...
     * @param query **Search**. You can search by providing a keyword. Allowed to search by type and name only.  (optional)
     ...
     */
    public okhttp3.Call throttlingPolicySearchCall(String query, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call throttlingPolicySearchValidateBeforeCall(String query, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = throttlingPolicySearchCall(query, _callback);
        return localVarCall;
    ...
    public ThrottlePolicyDetailsListDTO throttlingPolicySearch(String query) throws ApiException {
        ApiResponse<ThrottlePolicyDetailsListDTO> localVarResp = throttlingPolicySearchWithHttpInfo(query);
    ...
    public ApiResponse<ThrottlePolicyDetailsListDTO> throttlingPolicySearchWithHttpInfo(String query) throws ApiException {
        okhttp3.Call localVarCall = throttlingPolicySearchValidateBeforeCall(query, null);
     ...
     */
    public okhttp3.Call throttlingPolicySearchAsync(String query, final ApiCallback<ThrottlePolicyDetailsListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = throttlingPolicySearchValidateBeforeCall(query, _callback);
        Type localVarReturnType = new TypeToken<ThrottlePolicyDetailsListDTO>(){}.getType();
