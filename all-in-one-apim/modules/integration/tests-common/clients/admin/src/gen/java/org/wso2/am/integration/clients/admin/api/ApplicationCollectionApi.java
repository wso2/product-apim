...
public class ApplicationCollectionApi {
     ...
     */
    public okhttp3.Call applicationsGetCall(String user, Integer limit, Integer offset, String accept, String ifNoneMatch, String name, String tenantDomain, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call applicationsGetValidateBeforeCall(String user, Integer limit, Integer offset, String accept, String ifNoneMatch, String name, String tenantDomain, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = applicationsGetCall(user, limit, offset, accept, ifNoneMatch, name, tenantDomain, _callback);
        return localVarCall;
     ...
     */
    public ApplicationListDTO applicationsGet(String user, Integer limit, Integer offset, String accept, String ifNoneMatch, String name, String tenantDomain) throws ApiException {
        ApiResponse<ApplicationListDTO> localVarResp = applicationsGetWithHttpInfo(user, limit, offset, accept, ifNoneMatch, name, tenantDomain);
     ...
     */
    public ApiResponse<ApplicationListDTO> applicationsGetWithHttpInfo(String user, Integer limit, Integer offset, String accept, String ifNoneMatch, String name, String tenantDomain) throws ApiException {
        okhttp3.Call localVarCall = applicationsGetValidateBeforeCall(user, limit, offset, accept, ifNoneMatch, name, tenantDomain, null);
     ...
     */
    public okhttp3.Call applicationsGetAsync(String user, Integer limit, Integer offset, String accept, String ifNoneMatch, String name, String tenantDomain, final ApiCallback<ApplicationListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = applicationsGetValidateBeforeCall(user, limit, offset, accept, ifNoneMatch, name, tenantDomain, _callback);
        Type localVarReturnType = new TypeToken<ApplicationListDTO>(){}.getType();
