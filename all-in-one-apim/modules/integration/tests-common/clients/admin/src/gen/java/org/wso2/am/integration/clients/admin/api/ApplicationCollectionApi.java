...
public class ApplicationCollectionApi {
     ...
     * @param name Application Name  (optional)
     ...
     * @param sortBy  (optional, default to name)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> OK. Application list returned.  </td><td>  * Content-Type - The content type of the body.  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad Request. Invalid request or validation error. </td><td>  -  </td></tr>
        <tr><td> 406 </td><td> Not Acceptable. The requested media type is not supported. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call applicationsGetCall(String user, Integer limit, Integer offset, String accept, String name, String tenantDomain, String sortBy, String sortOrder, final ApiCallback _callback) throws ApiException {
        ...
        if (tenantDomain != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("tenantDomain", tenantDomain));
        }
    ...
    private okhttp3.Call applicationsGetValidateBeforeCall(String user, Integer limit, Integer offset, String accept, String name, String tenantDomain, String sortBy, String sortOrder, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = applicationsGetCall(user, limit, offset, accept, name, tenantDomain, sortBy, sortOrder, _callback);
        return localVarCall;
     ...
     */
    public ApplicationListDTO applicationsGet(String user, Integer limit, Integer offset, String accept, String name, String tenantDomain, String sortBy, String sortOrder) throws ApiException {
        ApiResponse<ApplicationListDTO> localVarResp = applicationsGetWithHttpInfo(user, limit, offset, accept, name, tenantDomain, sortBy, sortOrder);
     ...
     */
    public ApiResponse<ApplicationListDTO> applicationsGetWithHttpInfo(String user, Integer limit, Integer offset, String accept, String name, String tenantDomain, String sortBy, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = applicationsGetValidateBeforeCall(user, limit, offset, accept, name, tenantDomain, sortBy, sortOrder, null);
     ...
     */
    public okhttp3.Call applicationsGetAsync(String user, Integer limit, Integer offset, String accept, String name, String tenantDomain, String sortBy, String sortOrder, final ApiCallback<ApplicationListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = applicationsGetValidateBeforeCall(user, limit, offset, accept, name, tenantDomain, sortBy, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<ApplicationListDTO>(){}.getType();
