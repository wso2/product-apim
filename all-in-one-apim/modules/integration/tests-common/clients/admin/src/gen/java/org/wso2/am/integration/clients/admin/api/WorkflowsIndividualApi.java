...
public class WorkflowsIndividualApi {
     ...
     */
    public okhttp3.Call workflowsExternalWorkflowRefGetCall(String externalWorkflowRef, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call workflowsExternalWorkflowRefGetValidateBeforeCall(String externalWorkflowRef, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = workflowsExternalWorkflowRefGetCall(externalWorkflowRef, _callback);
        return localVarCall;
     ...
     */
    public WorkflowInfoDTO workflowsExternalWorkflowRefGet(String externalWorkflowRef) throws ApiException {
        ApiResponse<WorkflowInfoDTO> localVarResp = workflowsExternalWorkflowRefGetWithHttpInfo(externalWorkflowRef);
     ...
     */
    public ApiResponse<WorkflowInfoDTO> workflowsExternalWorkflowRefGetWithHttpInfo(String externalWorkflowRef) throws ApiException {
        okhttp3.Call localVarCall = workflowsExternalWorkflowRefGetValidateBeforeCall(externalWorkflowRef, null);
     ...
     */
    public okhttp3.Call workflowsExternalWorkflowRefGetAsync(String externalWorkflowRef, final ApiCallback<WorkflowInfoDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = workflowsExternalWorkflowRefGetValidateBeforeCall(externalWorkflowRef, _callback);
        Type localVarReturnType = new TypeToken<WorkflowInfoDTO>(){}.getType();
