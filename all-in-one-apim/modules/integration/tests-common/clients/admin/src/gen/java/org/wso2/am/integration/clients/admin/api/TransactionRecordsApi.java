...
import org.wso2.am.integration.clients.admin.api.dto.TransactionCountDTO;
...
public class TransactionRecordsApi {
    ...
    public TransactionRecordsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public TransactionRecordsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for transactionCountGet
     * @param startTime Start time for the transaction count retrieval (required)
     * @param endTime End time for the transaction count retrieval (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Transaction count retrieved successfully </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Unexpected error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call transactionCountGetCall(String startTime, String endTime, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call transactionCountGetValidateBeforeCall(String startTime, String endTime, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'startTime' is set
        if (startTime == null) {
            throw new ApiException("Missing the required parameter 'startTime' when calling transactionCountGet(Async)");
        }
        
        // verify the required parameter 'endTime' is set
        if (endTime == null) {
            throw new ApiException("Missing the required parameter 'endTime' when calling transactionCountGet(Async)");
        }
        

        okhttp3.Call localVarCall = transactionCountGetCall(startTime, endTime, _callback);
        return localVarCall;
     ...
     * This endpoint retrieves the transaction count based on various filter parameters.
     * @param startTime Start time for the transaction count retrieval (required)
     * @param endTime End time for the transaction count retrieval (required)
     ...
     */
    public TransactionCountDTO transactionCountGet(String startTime, String endTime) throws ApiException {
        ApiResponse<TransactionCountDTO> localVarResp = transactionCountGetWithHttpInfo(startTime, endTime);
     ...
     * @param startTime Start time for the transaction count retrieval (required)
     * @param endTime End time for the transaction count retrieval (required)
     * @return ApiResponse&lt;TransactionCountDTO&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<TransactionCountDTO> transactionCountGetWithHttpInfo(String startTime, String endTime) throws ApiException {
        okhttp3.Call localVarCall = transactionCountGetValidateBeforeCall(startTime, endTime, null);
        Type localVarReturnType = new TypeToken<TransactionCountDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get transaction count (asynchronously)
     * This endpoint retrieves the transaction count based on various filter parameters.
     * @param startTime Start time for the transaction count retrieval (required)
     * @param endTime End time for the transaction count retrieval (required)
     ...
     */
    public okhttp3.Call transactionCountGetAsync(String startTime, String endTime, final ApiCallback<TransactionCountDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = transactionCountGetValidateBeforeCall(startTime, endTime, _callback);
        Type localVarReturnType = new TypeToken<TransactionCountDTO>(){}.getType();
