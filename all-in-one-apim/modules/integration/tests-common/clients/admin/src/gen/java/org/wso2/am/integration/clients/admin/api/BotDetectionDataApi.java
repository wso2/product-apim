...
public class BotDetectionDataApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> OK. Bot detected data returned.  </td><td>  * Content-Type - The content type of the body.  <br>  </td></tr>
        <tr><td> 404 </td><td> Not Found. The specified resource does not exist. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getBotDetectionDataCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getBotDetectionDataValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getBotDetectionDataCall(_callback);
        return localVarCall;
    ...
    public BotDetectionDataListDTO getBotDetectionData() throws ApiException {
        ApiResponse<BotDetectionDataListDTO> localVarResp = getBotDetectionDataWithHttpInfo();
    ...
    public ApiResponse<BotDetectionDataListDTO> getBotDetectionDataWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getBotDetectionDataValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call getBotDetectionDataAsync(final ApiCallback<BotDetectionDataListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getBotDetectionDataValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<BotDetectionDataListDTO>(){}.getType();
