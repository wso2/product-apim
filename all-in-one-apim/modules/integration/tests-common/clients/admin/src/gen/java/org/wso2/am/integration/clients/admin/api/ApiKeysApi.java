...
import org.wso2.am.integration.clients.admin.api.dto.APIKeyListDTO;
import org.wso2.am.integration.clients.admin.api.dto.APIKeyRevokeRequestDTO;
...
public class ApiKeysApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> OK. API keys returned.  </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call getAllAPIKeysCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllAPIKeysValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAllAPIKeysCall(_callback);
        return localVarCall;
     ...
     */
    public APIKeyListDTO getAllAPIKeys() throws ApiException {
        ApiResponse<APIKeyListDTO> localVarResp = getAllAPIKeysWithHttpInfo();
     ...
     */
    public ApiResponse<APIKeyListDTO> getAllAPIKeysWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getAllAPIKeysValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call getAllAPIKeysAsync(final ApiCallback<APIKeyListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllAPIKeysValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<APIKeyListDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for revokeAPIKeyFromAdmin
     * @param apIKeyRevokeRequestDTO API key revoke object  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call revokeAPIKeyFromAdminCall(APIKeyRevokeRequestDTO apIKeyRevokeRequestDTO, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = apIKeyRevokeRequestDTO;

        // create path and map variables
        String localVarPath = "/api-keys/revoke";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call revokeAPIKeyFromAdminValidateBeforeCall(APIKeyRevokeRequestDTO apIKeyRevokeRequestDTO, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'apIKeyRevokeRequestDTO' is set
        if (apIKeyRevokeRequestDTO == null) {
            throw new ApiException("Missing the required parameter 'apIKeyRevokeRequestDTO' when calling revokeAPIKeyFromAdmin(Async)");
        }
        

        okhttp3.Call localVarCall = revokeAPIKeyFromAdminCall(apIKeyRevokeRequestDTO, _callback);
        return localVarCall;
     ...
     */
    public void revokeAPIKeyFromAdmin(APIKeyRevokeRequestDTO apIKeyRevokeRequestDTO) throws ApiException {
        revokeAPIKeyFromAdminWithHttpInfo(apIKeyRevokeRequestDTO);
    }
     ...
     */
    public ApiResponse<Void> revokeAPIKeyFromAdminWithHttpInfo(APIKeyRevokeRequestDTO apIKeyRevokeRequestDTO) throws ApiException {
        okhttp3.Call localVarCall = revokeAPIKeyFromAdminValidateBeforeCall(apIKeyRevokeRequestDTO, null);
     ...
     */
    public okhttp3.Call revokeAPIKeyFromAdminAsync(APIKeyRevokeRequestDTO apIKeyRevokeRequestDTO, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = revokeAPIKeyFromAdminValidateBeforeCall(apIKeyRevokeRequestDTO, _callback);
