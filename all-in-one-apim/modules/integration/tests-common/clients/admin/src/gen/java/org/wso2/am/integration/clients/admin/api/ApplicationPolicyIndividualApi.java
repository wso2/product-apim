...
public class ApplicationPolicyIndividualApi {
     ...
     */
    public okhttp3.Call throttlingPoliciesApplicationPolicyIdDeleteCall(String policyId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call throttlingPoliciesApplicationPolicyIdDeleteValidateBeforeCall(String policyId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = throttlingPoliciesApplicationPolicyIdDeleteCall(policyId, _callback);
        return localVarCall;
     ...
     */
    public void throttlingPoliciesApplicationPolicyIdDelete(String policyId) throws ApiException {
     ...
     */
    public ApiResponse<Void> throttlingPoliciesApplicationPolicyIdDeleteWithHttpInfo(String policyId) throws ApiException {
        okhttp3.Call localVarCall = throttlingPoliciesApplicationPolicyIdDeleteValidateBeforeCall(policyId, null);
     ...
     */
    public okhttp3.Call throttlingPoliciesApplicationPolicyIdDeleteAsync(String policyId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = throttlingPoliciesApplicationPolicyIdDeleteValidateBeforeCall(policyId, _callback);
     ...
     */
    public okhttp3.Call throttlingPoliciesApplicationPolicyIdGetCall(String policyId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call throttlingPoliciesApplicationPolicyIdGetValidateBeforeCall(String policyId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = throttlingPoliciesApplicationPolicyIdGetCall(policyId, _callback);
        return localVarCall;
     ...
     */
    public ApplicationThrottlePolicyDTO throttlingPoliciesApplicationPolicyIdGet(String policyId) throws ApiException {
        ApiResponse<ApplicationThrottlePolicyDTO> localVarResp = throttlingPoliciesApplicationPolicyIdGetWithHttpInfo(policyId);
     ...
     */
    public ApiResponse<ApplicationThrottlePolicyDTO> throttlingPoliciesApplicationPolicyIdGetWithHttpInfo(String policyId) throws ApiException {
        okhttp3.Call localVarCall = throttlingPoliciesApplicationPolicyIdGetValidateBeforeCall(policyId, null);
     ...
     */
    public okhttp3.Call throttlingPoliciesApplicationPolicyIdGetAsync(String policyId, final ApiCallback<ApplicationThrottlePolicyDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = throttlingPoliciesApplicationPolicyIdGetValidateBeforeCall(policyId, _callback);
        Type localVarReturnType = new TypeToken<ApplicationThrottlePolicyDTO>(){}.getType();
     ...
     */
    public okhttp3.Call throttlingPoliciesApplicationPolicyIdPutCall(String policyId, String contentType, ApplicationThrottlePolicyDTO applicationThrottlePolicyDTO, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call throttlingPoliciesApplicationPolicyIdPutValidateBeforeCall(String policyId, String contentType, ApplicationThrottlePolicyDTO applicationThrottlePolicyDTO, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = throttlingPoliciesApplicationPolicyIdPutCall(policyId, contentType, applicationThrottlePolicyDTO, _callback);
        return localVarCall;
     ...
     */
    public ApplicationThrottlePolicyDTO throttlingPoliciesApplicationPolicyIdPut(String policyId, String contentType, ApplicationThrottlePolicyDTO applicationThrottlePolicyDTO) throws ApiException {
        ApiResponse<ApplicationThrottlePolicyDTO> localVarResp = throttlingPoliciesApplicationPolicyIdPutWithHttpInfo(policyId, contentType, applicationThrottlePolicyDTO);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ApplicationThrottlePolicyDTO> throttlingPoliciesApplicationPolicyIdPutWithHttpInfo(String policyId, String contentType, ApplicationThrottlePolicyDTO applicationThrottlePolicyDTO) throws ApiException {
        okhttp3.Call localVarCall = throttlingPoliciesApplicationPolicyIdPutValidateBeforeCall(policyId, contentType, applicationThrottlePolicyDTO, null);
        Type localVarReturnType = new TypeToken<ApplicationThrottlePolicyDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call throttlingPoliciesApplicationPolicyIdPutAsync(String policyId, String contentType, ApplicationThrottlePolicyDTO applicationThrottlePolicyDTO, final ApiCallback<ApplicationThrottlePolicyDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = throttlingPoliciesApplicationPolicyIdPutValidateBeforeCall(policyId, contentType, applicationThrottlePolicyDTO, _callback);
        Type localVarReturnType = new TypeToken<ApplicationThrottlePolicyDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
