...
public class TenantsApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> OK. Custom url info of the tenant is retrieved.  </td><td>  * Content-Type - The content type of the body.  <br>  </td></tr>
        <tr><td> 404 </td><td> Not Found. The specified resource does not exist. </td><td>  -  </td></tr>
        <tr><td> 406 </td><td> Not Acceptable. The requested media type is not supported. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getCustomUrlInfoByTenantDomainCall(String tenantDomain, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getCustomUrlInfoByTenantDomainValidateBeforeCall(String tenantDomain, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getCustomUrlInfoByTenantDomainCall(tenantDomain, _callback);
        return localVarCall;
    ...
    public CustomUrlInfoDTO getCustomUrlInfoByTenantDomain(String tenantDomain) throws ApiException {
        ApiResponse<CustomUrlInfoDTO> localVarResp = getCustomUrlInfoByTenantDomainWithHttpInfo(tenantDomain);
    ...
    public ApiResponse<CustomUrlInfoDTO> getCustomUrlInfoByTenantDomainWithHttpInfo(String tenantDomain) throws ApiException {
        okhttp3.Call localVarCall = getCustomUrlInfoByTenantDomainValidateBeforeCall(tenantDomain, null);
     ...
     */
    public okhttp3.Call getCustomUrlInfoByTenantDomainAsync(String tenantDomain, final ApiCallback<CustomUrlInfoDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCustomUrlInfoByTenantDomainValidateBeforeCall(tenantDomain, _callback);
        Type localVarReturnType = new TypeToken<CustomUrlInfoDTO>(){}.getType();
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK. Tenant id of the user retrieved.  </td><td>  * Content-Type - The content type of the body.  <br>  </td></tr>
        <tr><td> 404 </td><td> Not Found. The specified resource does not exist. </td><td>  -  </td></tr>
        <tr><td> 406 </td><td> Not Acceptable. The requested media type is not supported. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getTenantInfoByUsernameCall(String username, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTenantInfoByUsernameValidateBeforeCall(String username, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getTenantInfoByUsernameCall(username, _callback);
        return localVarCall;
    ...
    public TenantInfoDTO getTenantInfoByUsername(String username) throws ApiException {
        ApiResponse<TenantInfoDTO> localVarResp = getTenantInfoByUsernameWithHttpInfo(username);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<TenantInfoDTO> getTenantInfoByUsernameWithHttpInfo(String username) throws ApiException {
        okhttp3.Call localVarCall = getTenantInfoByUsernameValidateBeforeCall(username, null);
     ...
     */
    public okhttp3.Call getTenantInfoByUsernameAsync(String username, final ApiCallback<TenantInfoDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTenantInfoByUsernameValidateBeforeCall(username, _callback);
        Type localVarReturnType = new TypeToken<TenantInfoDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
