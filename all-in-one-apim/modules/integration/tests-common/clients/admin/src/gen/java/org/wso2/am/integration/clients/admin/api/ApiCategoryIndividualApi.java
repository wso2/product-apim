...
public class ApiCategoryIndividualApi {
     ...
     */
    public okhttp3.Call apiCategoriesApiCategoryIdDeleteCall(String apiCategoryId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call apiCategoriesApiCategoryIdDeleteValidateBeforeCall(String apiCategoryId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = apiCategoriesApiCategoryIdDeleteCall(apiCategoryId, _callback);
        return localVarCall;
     ...
     */
    public void apiCategoriesApiCategoryIdDelete(String apiCategoryId) throws ApiException {
        apiCategoriesApiCategoryIdDeleteWithHttpInfo(apiCategoryId);
    }
     ...
     */
    public ApiResponse<Void> apiCategoriesApiCategoryIdDeleteWithHttpInfo(String apiCategoryId) throws ApiException {
        okhttp3.Call localVarCall = apiCategoriesApiCategoryIdDeleteValidateBeforeCall(apiCategoryId, null);
     ...
     */
    public okhttp3.Call apiCategoriesApiCategoryIdDeleteAsync(String apiCategoryId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiCategoriesApiCategoryIdDeleteValidateBeforeCall(apiCategoryId, _callback);
