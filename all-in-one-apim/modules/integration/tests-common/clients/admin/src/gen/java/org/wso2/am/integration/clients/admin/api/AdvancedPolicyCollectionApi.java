...
public class AdvancedPolicyCollectionApi {
     ...
     */
    public okhttp3.Call throttlingPoliciesAdvancedGetCall(String accept, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call throttlingPoliciesAdvancedGetValidateBeforeCall(String accept, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = throttlingPoliciesAdvancedGetCall(accept, _callback);
        return localVarCall;
     ...
     */
    public AdvancedThrottlePolicyListDTO throttlingPoliciesAdvancedGet(String accept) throws ApiException {
        ApiResponse<AdvancedThrottlePolicyListDTO> localVarResp = throttlingPoliciesAdvancedGetWithHttpInfo(accept);
     ...
     */
    public ApiResponse<AdvancedThrottlePolicyListDTO> throttlingPoliciesAdvancedGetWithHttpInfo(String accept) throws ApiException {
        okhttp3.Call localVarCall = throttlingPoliciesAdvancedGetValidateBeforeCall(accept, null);
     ...
     */
    public okhttp3.Call throttlingPoliciesAdvancedGetAsync(String accept, final ApiCallback<AdvancedThrottlePolicyListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = throttlingPoliciesAdvancedGetValidateBeforeCall(accept, _callback);
        Type localVarReturnType = new TypeToken<AdvancedThrottlePolicyListDTO>(){}.getType();
     ...
     * @param advancedThrottlePolicyDTO Advanced level policy object that should to be added  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Created. Successful response with the newly created object as entity in the body. Location header contains URL of newly created entity.  </td><td>  * Location - Location of the newly created Advanced Throttling Policy.  <br>  * Content-Type - The content type of the body.  <br>  </td></tr>
     ...
     */
    public okhttp3.Call throttlingPoliciesAdvancedPostCall(String contentType, AdvancedThrottlePolicyDTO advancedThrottlePolicyDTO, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call throttlingPoliciesAdvancedPostValidateBeforeCall(String contentType, AdvancedThrottlePolicyDTO advancedThrottlePolicyDTO, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = throttlingPoliciesAdvancedPostCall(contentType, advancedThrottlePolicyDTO, _callback);
        return localVarCall;
    ...
    public AdvancedThrottlePolicyDTO throttlingPoliciesAdvancedPost(String contentType, AdvancedThrottlePolicyDTO advancedThrottlePolicyDTO) throws ApiException {
        ApiResponse<AdvancedThrottlePolicyDTO> localVarResp = throttlingPoliciesAdvancedPostWithHttpInfo(contentType, advancedThrottlePolicyDTO);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<AdvancedThrottlePolicyDTO> throttlingPoliciesAdvancedPostWithHttpInfo(String contentType, AdvancedThrottlePolicyDTO advancedThrottlePolicyDTO) throws ApiException {
        okhttp3.Call localVarCall = throttlingPoliciesAdvancedPostValidateBeforeCall(contentType, advancedThrottlePolicyDTO, null);
     ...
     */
    public okhttp3.Call throttlingPoliciesAdvancedPostAsync(String contentType, AdvancedThrottlePolicyDTO advancedThrottlePolicyDTO, final ApiCallback<AdvancedThrottlePolicyDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = throttlingPoliciesAdvancedPostValidateBeforeCall(contentType, advancedThrottlePolicyDTO, _callback);
        Type localVarReturnType = new TypeToken<AdvancedThrottlePolicyDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
