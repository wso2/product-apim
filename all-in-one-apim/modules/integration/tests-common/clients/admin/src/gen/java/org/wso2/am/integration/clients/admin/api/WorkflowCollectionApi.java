...
public class WorkflowCollectionApi {
     ...
     * @param workflowType We need to show the values of each workflow process separately .for that we use workflow type. Workflow type can be AM_APPLICATION_CREATION, AM_SUBSCRIPTION_CREATION,   AM_USER_SIGNUP, AM_APPLICATION_REGISTRATION_PRODUCTION, AM_APPLICATION_REGISTRATION_SANDBOX, AM_APPLICATION_UPDATE.  (optional)
     ...
     */
    public okhttp3.Call workflowsGetCall(Integer limit, Integer offset, String accept, String ifNoneMatch, String workflowType, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call workflowsGetValidateBeforeCall(Integer limit, Integer offset, String accept, String ifNoneMatch, String workflowType, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = workflowsGetCall(limit, offset, accept, ifNoneMatch, workflowType, _callback);
        return localVarCall;
    ...
    public WorkflowListDTO workflowsGet(Integer limit, Integer offset, String accept, String ifNoneMatch, String workflowType) throws ApiException {
        ApiResponse<WorkflowListDTO> localVarResp = workflowsGetWithHttpInfo(limit, offset, accept, ifNoneMatch, workflowType);
    ...
    public ApiResponse<WorkflowListDTO> workflowsGetWithHttpInfo(Integer limit, Integer offset, String accept, String ifNoneMatch, String workflowType) throws ApiException {
        okhttp3.Call localVarCall = workflowsGetValidateBeforeCall(limit, offset, accept, ifNoneMatch, workflowType, null);
     ...
     */
    public okhttp3.Call workflowsGetAsync(Integer limit, Integer offset, String accept, String ifNoneMatch, String workflowType, final ApiCallback<WorkflowListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = workflowsGetValidateBeforeCall(limit, offset, accept, ifNoneMatch, workflowType, _callback);
        Type localVarReturnType = new TypeToken<WorkflowListDTO>(){}.getType();
