...
public class WorkflowCollectionApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> OK. Workflow pendding process list returned.  </td><td>  * Content-Type - The content type of the body.  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad Request. Invalid request or validation error. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Not Found. The specified resource does not exist. </td><td>  -  </td></tr>
        <tr><td> 406 </td><td> Not Acceptable. The requested media type is not supported. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call workflowsGetCall(Integer limit, Integer offset, String accept, String workflowType, final ApiCallback _callback) throws ApiException {
        ...
        if (workflowType != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("workflowType", workflowType));
        }
    ...
    private okhttp3.Call workflowsGetValidateBeforeCall(Integer limit, Integer offset, String accept, String workflowType, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = workflowsGetCall(limit, offset, accept, workflowType, _callback);
        return localVarCall;
     ...
     */
    public WorkflowListDTO workflowsGet(Integer limit, Integer offset, String accept, String workflowType) throws ApiException {
        ApiResponse<WorkflowListDTO> localVarResp = workflowsGetWithHttpInfo(limit, offset, accept, workflowType);
     ...
     */
    public ApiResponse<WorkflowListDTO> workflowsGetWithHttpInfo(Integer limit, Integer offset, String accept, String workflowType) throws ApiException {
        okhttp3.Call localVarCall = workflowsGetValidateBeforeCall(limit, offset, accept, workflowType, null);
     ...
     */
    public okhttp3.Call workflowsGetAsync(Integer limit, Integer offset, String accept, String workflowType, final ApiCallback<WorkflowListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = workflowsGetValidateBeforeCall(limit, offset, accept, workflowType, _callback);
        Type localVarReturnType = new TypeToken<WorkflowListDTO>(){}.getType();
