...
WSO2 Traffic Manager (WSO2 APIM-TM) is a powerful platform for creating, managing, consuming, and
...
WSO2 Traffic Manager is based on the revolutionary WSO2 Carbon [Middleware a' la carte]
framework. All the major features have been developed as reusable Carbon
components.

To learn more about WSO2 Traffic Manager please visit http://wso2.com/products/api-manager.
...
1. Extract the wso2am-tm-4.5.0.zip and go to the 'bin' directory
