...
public class APIMANAGER5872UpdateAPIWithoutThumbnailValueAndAPISummaryTestCase extends APIMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;
    @Factory(dataProvider = "userModeDataProvider")
    public APIMANAGER5872UpdateAPIWithoutThumbnailValueAndAPISummaryTestCase(TestUserMode userMode) {
    ...
    @Test(groups = { "wso2.am" }, description = "REST API test: Create API and update it without thumbnail attribute. " +
                                                "Thus shouldn't remove existing thumbnail")
    public void testUpdateAPIwhichHasThumbnail() {
        ...
        String dataFileName =  "APIMANAGER5872TestCaseResource1.txt";
