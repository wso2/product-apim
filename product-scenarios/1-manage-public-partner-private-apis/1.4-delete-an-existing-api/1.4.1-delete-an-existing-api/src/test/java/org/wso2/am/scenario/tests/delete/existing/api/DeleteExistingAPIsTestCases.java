...
public class DeleteExistingAPIsTestCases extends ScenarioTestBase {
    ...
    public void testDeleteAPIAfterDeleteSubscribedApplication(APILifeCycleState state) throws Exception {
        ...
        if (state.equals(APILifeCycleState.PUBLISHED)) {
            SubscriptionDTO subscriptionDTO1 = restAPIStore.subscribeToAPI(apiID, applicationID,
                    APIMIntegrationConstants.API_TIER.UNLIMITED);
            verifyResponse(restAPIStore.removeSubscription(subscriptionDTO1));
        }
    ...
    private String createApplication(String applicationName) throws APIManagerIntegrationTestException {
