...
public class APIStoreRestClient {
    private static final Log log = LogFactory.getLog(org.wso2.am.integration.test.utils.clients.APIStoreRestClient.class);
    ...
    public HttpResponse generateUserAccessKey(String consumeKey, String consumerSecret,
        ...
        try {
            ...
            return HttpClient.doPost(tokenEndpointURL, messageBody, authenticationRequestHeaders);
    ...
    public HttpResponse updateClientApplication(String application, String keyType, String authorizedDomains,
        ...
        try {
            checkAuthentication();
            return HttpClient.doPost(new URL(backendURL
        ...
        try {
            ...
            for (int i = 0; i < arr.length(); i++) {
                ...
                if (applicationName.equals(appName)) {
                    applicationId = arr.getJSONObject(i).get("id").toString();
                }
            }
     ...
     *                                            HttpClient.sendGetRequest() method call
     */
...
//    }
    ...
    public HttpResponse searchPaginateAPIs(String tenant, String start, String end,
            ...
            throws Exception {
        checkAuthentication();
        HttpResponse response = HttpClient.doPost(new URL(
    ...
    public HttpResponse getApplicationPage() throws APIManagerIntegrationTestException {
        try {
            checkAuthentication();
            return HttpClient.doPost(new URL(backendURL + APIMIntegrationConstants.STORE_APPLICATION_REST_URL), "",
                    requestHeaders);
