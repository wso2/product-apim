...
//                        do nothing
    ...
    /**
     * Check if a web application is deployed
     * 
     * @deprecated WebApp deployment verification has been simplified since webapps are now deployed during server startup
     * @param serviceEndpoint service endpoint (not used anymore)
     * @param username username (not used anymore)
     * @param password password (not used anymore)
     * @param webAppFileName web app file name
     * @return always returns true since webapps are deployed during server startup
     * @throws RemoteException not thrown anymore
     * @throws APIManagementException not thrown anymore
     */
    @Deprecated
